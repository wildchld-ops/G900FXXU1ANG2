...
.method private beginResizeIfPointInRegion(II)Z
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/launcher2/CellLayout;->getExpandabilityArrayForView(Landroid/view/View;[I)V
...
.method public isPointInFrame(FF)Z
    ...
    iget v3, p0, Lcom/android/launcher2/AppWidgetResizeFrame;->mBackgroundPadding:I
    ...
    :cond_0
    sget-boolean v2, Lcom/android/launcher2/AppWidgetResizeFrame;->DEBUGGABLE:Z

    if-eqz v2, :cond_1

    const-string v2, "Launcher.ResizeFrame"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "isPointInFrame::frame -  "
    ...
    const-string v4, "isPointInFrame::pointX -  "
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v9}, Landroid/view/ViewGroup;->requestDisallowInterceptTouchEvent(Z)V
