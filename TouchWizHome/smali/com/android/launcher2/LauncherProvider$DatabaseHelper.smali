...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v4, p0, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->mIsAttReady2GoEnable:Z

    iput-object v3, p0, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->mParserRestore:Lorg/xmlpull/v1/XmlPullParser;

    iput-object v3, p0, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->mWidgetTitle:Ljava/lang/String;

    iput-boolean v4, p0, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->mOnlyLoadFrontApps:Z
    ...
    const-string v2, "DATABASE_VERSION = 13"
    ...
    invoke-direct {p0, v1}, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->getMaxFavoriteID(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/concurrent/atomic/AtomicLong;
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->createFavorites(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    const-string v1, "favorites"

    invoke-direct {p0, v0, v1}, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->loadFavorites4CP(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->initializeMaxId(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)J
...
.method private addAppWidget(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Landroid/content/ContentValues;Landroid/content/ComponentName;II)Z
    ...
    invoke-static {p0, p1, p2, v7, p3}, Lcom/android/launcher2/LauncherProvider;->dbInsertAndCheck(Lcom/android/launcher2/LauncherProvider$DatabaseHelper;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    ...
    const-string v8, "PrefsForContextualPagePackageName"
    ...
    const-string v8, "PrefsForContextualPageClassName"
    ...
    const-string v8, "[CP] cp widget is skiped!"
...
.method private createAppOrderTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v0, "CREATE table appOrder (_id integer primary key,folderId integer not null default -1,screen integer not null default -1,cell integer not null default -1,hidden integer not null default 0,title text,componentName text,color integer not null default -1);"
...
.method private loadFavoritesContainer(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Lorg/xmlpull/v1/XmlPullParser;JIZ)I
    ...
    const-string v5, "isContextualPage"
...
.method public onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    const-string v7, "onDowngrade triggered :: oldVersion:"
    ...
    const-string v7, "onDownGrade:: Dropping extra table:"
    ...
    invoke-direct {p0, p1, v5}, Lcom/android/launcher2/LauncherProvider$DatabaseHelper;->doesTableExist(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    const-string v6, "onDownGrade:: favorites/appOrder doesnot exist"
    ...
    const-string v5, "DROP TABLE IF EXISTS favorites_cp"
    ...
    const-string v5, "DROP TABLE IF EXISTS prefs"
    ...
    const-string v6, "onDownGrade:: favorites_cp doesnot exist"
