...
.method public onFinishInflate()V
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mTabsView:Landroid/view/View;
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mTabDivider:Landroid/view/View;
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mTabGapView:Landroid/view/View;
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mDownloadedContainer:Landroid/view/View;
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mDownloadedButton:Landroid/widget/TextView;
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mDownloadedText:Ljava/lang/CharSequence;
    ...
    iput v6, p0, Lcom/android/launcher2/MenuView;->mDownloadedButtonDrawablePadding:I
    ...
    invoke-static {v6}, Lcom/android/launcher2/MenuView;->removeButton(Landroid/view/View;)V
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mMenuOrMarket:Landroid/view/View;

    :goto_0
    iget-object v6, p0, Lcom/android/launcher2/MenuView;->mMenuOrMarket:Landroid/view/View;

    if-eqz v6, :cond_1

    iget-object v6, p0, Lcom/android/launcher2/MenuView;->mMenuOrMarket:Landroid/view/View;

    sget-object v7, Lcom/android/launcher2/FocusHelper;->DOWNLOADED_ICON_KEY_LISTENER:Landroid/view/View$OnKeyListener;

    invoke-virtual {v6, v7}, Landroid/view/View;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    :cond_1
    iget-object v6, p0, Lcom/android/launcher2/MenuView;->mDownButton:Landroid/view/View;
    ...
    iget-object v6, p0, Lcom/android/launcher2/MenuView;->mTitleBarManager:Lcom/android/launcher2/MenuTitleBarManager;

    invoke-virtual {v6, p0}, Lcom/android/launcher2/MenuTitleBarManager;->init(Lcom/android/launcher2/MenuView;)V
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mMenuViewDarken:Landroid/view/View;
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mMenuContainer:Landroid/view/View;
    ...
    new-instance v6, Lcom/android/launcher2/tabs/TabManager;

    const v7, 0x1020011

    invoke-direct {v6, v1, p0, v7}, Lcom/android/launcher2/tabs/TabManager;-><init>(Landroid/app/Activity;Lcom/android/launcher2/MenuView;I)V

    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mTabManager:Lcom/android/launcher2/tabs/TabManager;
    ...
    invoke-virtual {v0, v6, v5, v10}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    invoke-virtual {v4, v10}, Landroid/view/View;->setHoverPopupType(I)V

    iput-object v4, p0, Lcom/android/launcher2/MenuView;->mAppsTabTextView:Landroid/widget/TextView;

    iget-object v7, p0, Lcom/android/launcher2/MenuView;->mTabManager:Lcom/android/launcher2/tabs/TabManager;

    const-string v6, "APPS"

    invoke-virtual {p0, v6}, Landroid/widget/TabHost;->newTabSpec(Ljava/lang/String;)Landroid/widget/TabHost$TabSpec;
    ...
    sget-object v9, Lcom/android/launcher2/MenuView$ViewType;->ALPHABETIC_LIST:Lcom/android/launcher2/MenuView$ViewType;

    if-ne v6, v9, :cond_4

    const-class v6, Lcom/android/launcher2/MenuAppsListFragment;

    :goto_1
    const/4 v9, 0x0

    invoke-virtual {v7, v8, v6, v9}, Lcom/android/launcher2/tabs/TabManager;->addTab(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V
    ...
    iput-object v4, p0, Lcom/android/launcher2/MenuView;->mWidgetsTabTextView:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v7}, Landroid/widget/TabHost;->newTabSpec(Ljava/lang/String;)Landroid/widget/TabHost$TabSpec;

    move-result-object v7

    invoke-virtual {v7, v4}, Landroid/widget/TabHost$TabSpec;->setIndicator(Landroid/view/View;)Landroid/widget/TabHost$TabSpec;

    move-result-object v7

    const-class v8, Lcom/android/launcher2/MenuWidgetsFragment;

    const/4 v9, 0x0

    invoke-virtual {v6, v7, v8, v9}, Lcom/android/launcher2/tabs/TabManager;->addTab(Landroid/widget/TabHost$TabSpec;Ljava/lang/Class;Landroid/os/Bundle;)V

    iget-object v6, p0, Lcom/android/launcher2/MenuView;->mTabManager:Lcom/android/launcher2/tabs/TabManager;

    sget-object v7, Lcom/android/launcher2/FocusHelper;->APPS_CUSTOMIZE_TABKEY_LISTENER:Landroid/view/View$OnKeyListener;

    invoke-virtual {v6, v7}, Lcom/android/launcher2/tabs/TabManager;->setLastTabKeyListener(Landroid/view/View$OnKeyListener;)V
    ...
    iput-object v6, p0, Lcom/android/launcher2/MenuView;->mDownButton:Landroid/view/View;

    goto/16 :goto_0

    :cond_4
    const-class v6, Lcom/android/launcher2/MenuAppsGridFragment;
...
.method public onShowAllApps()V
    ...
    sput-boolean v2, Lcom/android/launcher2/MenuView;->onShowAllAppsClicked:Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/launcher2/MenuWidgetsFragment;->changeWidgetState(Lcom/android/launcher2/MenuWidgets$WidgetState;)V

    :goto_0
    const-string v2, "APPS"

    invoke-virtual {p0, v2}, Landroid/widget/TabHost;->setCurrentTabByTag(Ljava/lang/String;)V

    :goto_1
    iget-object v2, p0, Lcom/android/launcher2/MenuView;->mMenuViewDarken:Landroid/view/View;
    ...
    new-instance v1, Lcom/android/launcher2/guide/AddWidgetsGuider;
    ...
    invoke-direct {v1, v2}, Lcom/android/launcher2/guide/AddWidgetsGuider;-><init>(Landroid/app/Activity;)V

    check-cast v1, Lcom/android/launcher2/guide/AddWidgetsGuider;

    invoke-virtual {v1}, Lcom/android/launcher2/guide/AddWidgetsGuider;->showHelpDialog_step3()V
    ...
    invoke-virtual {v2}, Lcom/android/launcher2/tabs/TabManager;->attachFragments()V
...
.method public setAccessibilityEnabled(Z)V
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/launcher2/MenuView;->mMenuOrMarket:Landroid/view/View;
    ...
    :cond_2
    iget-object v1, p0, Lcom/android/launcher2/MenuView;->mDownButton:Landroid/view/View;
    ...
    :cond_3
    iget-object v1, p0, Lcom/android/launcher2/MenuView;->mDownloadedButton:Landroid/widget/TextView;
