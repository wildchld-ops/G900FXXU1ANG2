...
.method private addCategoryFolder(Ljava/util/List;)V
    ...
    instance-of v13, v3, Lcom/android/launcher2/AvailableWidget;
    ...
    :cond_1
    instance-of v13, v3, Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-static {v12}, Lcom/android/launcher2/MenuWidgets;->sortByValues(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v13

    invoke-direct {p0, v13, v11}, Lcom/android/launcher2/MenuWidgets;->getSortedByPackage(Ljava/util/Map;Ljava/util/LinkedHashMap;)Ljava/util/Map;
    ...
    iput-object v13, p0, Lcom/android/launcher2/MenuWidgets;->mWidgetList:Ljava/util/List;
...
.method private beginDraggingWidget(Lcom/android/launcher2/PagedViewWidget;)V
    ...
    invoke-virtual {v5, v10, v11}, Lcom/android/launcher2/Launcher;->exitAllApps(ZZ)V
    ...
    invoke-virtual {v5, p0, v6, v10}, Lcom/sec/dtl/launcher/Talk;->sayByTalkback(Landroid/view/View;Ljava/lang/String;Z)V
...
.method private syncWidgetPageItems(IZ)V
    ...
    check-cast v28, Lcom/android/launcher2/WidgetFolderView;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/launcher2/HomePendingItem;->getComponentName()Landroid/content/ComponentName;
    ...
    new-instance v20, Landroid/widget/GridLayout$LayoutParams;
    ...
    check-cast v27, Lcom/android/launcher2/PagedViewWidget;
...
.method protected beginDragging(Landroid/view/View;)Z
    ...
    const-string v2, "This widget state is Uninstall"
    ...
    invoke-virtual {p0, v2}, Lcom/android/launcher2/PagedView;->requestDisallowInterceptTouchEvent(Z)V
...
.method public runFilter()V
    ...
    invoke-virtual {p0, v1}, Lcom/android/launcher2/PagedView;->invalidatePageData(I)V
