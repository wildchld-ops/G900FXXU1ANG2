...
.method public onDrag(Landroid/view/View;Landroid/view/DragEvent;)Z
    ...
    invoke-virtual {v0}, Lcom/android/launcher2/Launcher;->getContextualPageManager()Lcom/android/launcher2/ContextualPageManager;

    move-result-object v6

    if-eqz v6, :cond_5

    invoke-virtual {v6}, Lcom/android/launcher2/ContextualPageManager;->isCurCP()Z
    ...
    iget-object v0, v7, Lcom/android/launcher2/BaseItem;->mIconMovie:Landroid/graphics/Movie;

    if-nez v0, :cond_1

    iget-object v0, v8, Lcom/android/launcher2/DragState;->mDragOrigin:Lcom/android/launcher2/DragOrigin;

    if-eqz v0, :cond_1

    instance-of v0, v7, Lcom/android/launcher2/HomePendingItem;
    ...
    invoke-virtual {v8}, Lcom/android/launcher2/DragState;->getFolderParent()Lcom/android/launcher2/Folder;
    ...
    :pswitch_2
    invoke-direct {p0, v8}, Lcom/android/launcher2/HotseatSwapAnimator;->handleDragOverViewMove(Lcom/android/launcher2/DragState;)V

    iget-object v0, v8, Lcom/android/launcher2/DragState;->mUnderdragView:Landroid/view/View;
    ...
    invoke-virtual {v8}, Lcom/android/launcher2/DragState;->getView()Landroid/view/View;
    ...
    invoke-direct {p0, v8}, Lcom/android/launcher2/HotseatSwapAnimator;->animateOverlayIconBack(Lcom/android/launcher2/DragState;)V
    ...
    invoke-virtual {v9}, Lcom/android/launcher2/Folder;->ignoreShrinkingFolder()V

    invoke-virtual {v9, v12, v4}, Lcom/android/launcher2/Folder;->close(ZZ)V
    ...
    iget-object v1, v8, Lcom/android/launcher2/DragState;->mUnderdragView:Landroid/view/View;
    ...
    :cond_9
    invoke-direct {p0, v8}, Lcom/android/launcher2/HotseatSwapAnimator;->animateMoveFade(Lcom/android/launcher2/DragState;)V

    goto/16 :goto_1

    :pswitch_4
    invoke-direct {p0, v8}, Lcom/android/launcher2/HotseatSwapAnimator;->handleDragOverViewExit(Lcom/android/launcher2/DragState;)V
    ...
    :pswitch_5
    invoke-direct {p0, v8}, Lcom/android/launcher2/HotseatSwapAnimator;->fadeOutAndRemoveOverlayIcon(Lcom/android/launcher2/DragState;)V

    invoke-direct {p0, v8}, Lcom/android/launcher2/HotseatSwapAnimator;->handleDragOverViewDrop(Lcom/android/launcher2/DragState;)Z
    ...
    :pswitch_6
    invoke-direct {p0, v8}, Lcom/android/launcher2/HotseatSwapAnimator;->handleDragOverViewEnded(Lcom/android/launcher2/DragState;)V
