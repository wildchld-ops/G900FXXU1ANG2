...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/phone/PhotoRingScreen$15;,
...
.method static synthetic access$1600(Lcom/android/phone/PhotoRingScreen;)Z
    .locals 1
    .param p0    # Lcom/android/phone/PhotoRingScreen;
...
.method static synthetic access$1602(Lcom/android/phone/PhotoRingScreen;Z)Z
    .locals 0
    .param p0    # Lcom/android/phone/PhotoRingScreen;
    .param p1    # Z
...
.method static synthetic access$1700(Lcom/android/phone/PhotoRingScreen;)I
    .locals 1
    .param p0    # Lcom/android/phone/PhotoRingScreen;
...
.method static synthetic access$1702(Lcom/android/phone/PhotoRingScreen;I)I
    .locals 0
    .param p0    # Lcom/android/phone/PhotoRingScreen;
    .param p1    # I
...
.method static synthetic access$1800(Lcom/android/phone/PhotoRingScreen;)V
    .locals 0
    .param p0    # Lcom/android/phone/PhotoRingScreen;
...
.method static synthetic access$1900(Lcom/android/phone/PhotoRingScreen;)Ljava/lang/String;
    .locals 1
    .param p0    # Lcom/android/phone/PhotoRingScreen;
...
.method static synthetic access$2000(Lcom/android/phone/PhotoRingScreen;)Z
    .locals 1
    .param p0    # Lcom/android/phone/PhotoRingScreen;
...
.method static synthetic access$2002(Lcom/android/phone/PhotoRingScreen;Z)Z
    .locals 0
    .param p0    # Lcom/android/phone/PhotoRingScreen;
    .param p1    # Z
...
.method static synthetic access$2100(Lcom/android/phone/PhotoRingScreen;)Landroid/widget/CheckBox;
    .locals 1
    .param p0    # Lcom/android/phone/PhotoRingScreen;
...
.method static synthetic access$2200(Lcom/android/phone/PhotoRingScreen;)V
    .locals 0
    .param p0    # Lcom/android/phone/PhotoRingScreen;
...
.method private checkMobileData()Z
    ...
    new-instance v7, Lcom/android/phone/PhotoRingScreen$8;

    invoke-direct {v7, p0}, Lcom/android/phone/PhotoRingScreen$8;-><init>(Lcom/android/phone/PhotoRingScreen;)V

    invoke-virtual {v0, v6, v7}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    new-instance v6, Lcom/android/phone/PhotoRingScreen$9;

    invoke-direct {v6, p0}, Lcom/android/phone/PhotoRingScreen$9;-><init>(Lcom/android/phone/PhotoRingScreen;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-direct {p0, v9}, Lcom/android/phone/PhotoRingScreen;->log(Ljava/lang/String;)V
    ...
    :sswitch_1
    iget-object v9, p0, Lcom/android/phone/PhotoRingScreen;->mNumberText:Landroid/widget/AutoCompleteTextView;
    ...
    iget-object v9, p0, Lcom/android/phone/PhotoRingScreen;->mNumber:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/android/phone/PhotoRingScreen;->contactName:Ljava/lang/String;
    ...
    invoke-virtual {v9, v10}, Landroid/widget/TextView;->setError(Ljava/lang/CharSequence;)V

    iget-object v9, p0, Lcom/android/phone/PhotoRingScreen;->mNumberText:Landroid/widget/AutoCompleteTextView;

    invoke-virtual {v9}, Landroid/view/View;->requestFocus()Z

    iput-boolean v12, p0, Lcom/android/phone/PhotoRingScreen;->bEmptyNumErr:Z
    ...
    invoke-static {p0, v9}, Lcom/android/phone/PhotoringUtil;->showToast(Landroid/content/Context;I)V

    goto :goto_0

    :cond_3
    iget v9, p0, Lcom/android/phone/PhotoRingScreen;->mContentType:I

    if-nez v9, :cond_5

    iget-object v9, p0, Lcom/android/phone/PhotoRingScreen;->mRecipientsText:Landroid/widget/AutoCompleteTextView;
    ...
    :cond_5
    iget-boolean v9, p0, Lcom/android/phone/PhotoRingScreen;->mIsOverLength:Z
    ...
    const-string v10, "key_photoring_duty_show"
    ...
    const-string v10, "key_photoring_duty_media_show"
    ...
    iput-object v9, p0, Lcom/android/phone/PhotoRingScreen;->mCB:Landroid/widget/CheckBox;
    ...
    new-instance v10, Lcom/android/phone/PhotoRingScreen$11;

    invoke-direct {v10, p0}, Lcom/android/phone/PhotoRingScreen$11;-><init>(Lcom/android/phone/PhotoRingScreen;)V
    ...
    new-instance v9, Lcom/android/phone/PhotoRingScreen$12;

    invoke-direct {v9, p0}, Lcom/android/phone/PhotoRingScreen$12;-><init>(Lcom/android/phone/PhotoRingScreen;)V
    ...
    iget-object v9, p0, Lcom/android/phone/PhotoRingScreen;->mPM:Lcom/android/phone/PhotoRingMgr;

    iget-object v10, p0, Lcom/android/phone/PhotoRingScreen;->uploadPath:Ljava/lang/String;

    invoke-virtual {v9, v10}, Lcom/android/phone/PhotoRingMgr;->uploadContentCall(Ljava/lang/String;)V

    iget-object v9, p0, Lcom/android/phone/PhotoRingScreen;->pMe:Landroid/content/Context;
    ...
    const v11, 0x7f0908c1

    invoke-virtual {v10, v11}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v10

    invoke-static {v9, v10, v13}, Landroid/app/ProgressDialog;->show(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Landroid/app/ProgressDialog;

    move-result-object v9

    iput-object v9, p0, Lcom/android/phone/PhotoRingScreen;->mProgress:Landroid/app/ProgressDialog;

    goto/16 :goto_1

    :cond_b
    iput-boolean v12, p0, Lcom/android/phone/PhotoRingScreen;->mHasphotoringToDial:Z
    ...
    :sswitch_3
    const-string v9, "PhotoRingScreen"

    const-string v10, "add contact for photoring"
    ...
    sget-object v9, Lcom/android/phone/PhotoRingScreen;->mUriVideos:Landroid/net/Uri;
    ...
    const-string v9, "from_photoring_to_videoplayer"

    invoke-virtual {v5, v9, v12}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    const-string v11, "Couldn\'t play video "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    sget-object v11, Lcom/android/phone/PhotoRingScreen;->mUriVideos:Landroid/net/Uri;
    ...
    invoke-direct {p0, v9}, Lcom/android/phone/PhotoRingScreen;->editMenuSelected(I)V

    goto/16 :goto_0

    :sswitch_6
    invoke-direct {p0, v12}, Lcom/android/phone/PhotoRingScreen;->editMenuSelected(I)V

    goto/16 :goto_0

    :sswitch_7
    invoke-direct {p0, v11}, Lcom/android/phone/PhotoRingScreen;->editMenuSelected(I)V
    ...
    .sparse-switch
        ...
        0x7f0a0163 -> :sswitch_5
        0x7f0a0166 -> :sswitch_6
        0x7f0a0169 -> :sswitch_7
        0x7f0a016c -> :sswitch_8
        0x7f0a0192 -> :sswitch_4
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/android/phone/PhotoRingScreen;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v2, v0, v3}, Landroid/content/ContextWrapper;->openFileOutput(Ljava/lang/String;I)Ljava/io/FileOutputStream;
    ...
    iput-boolean v6, p0, Lcom/android/phone/PhotoRingScreen;->bShowOnly:Z
    ...
    const-string v2, "contentFrom : "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v2, p0, Lcom/android/phone/PhotoRingScreen;->mContentFrom:I
