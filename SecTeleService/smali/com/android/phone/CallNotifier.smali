...
.method private insertCallLog(Lcom/android/internal/telephony/Connection;)V
    ...
    invoke-direct {v0, v12}, Lcom/android/phone/CallNotifier;->getSendUriForHdCall(Landroid/net/Uri;)Landroid/net/Uri;
...
.method private onDisconnect(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v2, v6}, Landroid/content/ContextWrapper;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget v5, Lcom/android/phone/CallNotifier;->mSimId:I

    move-object/from16 v0, v27

    invoke-static {v0, v2, v5}, Landroid/telephony/PhoneNumberUtils;->isLocalEmergencyNumber(Ljava/lang/String;Landroid/content/Context;I)Z
    ...
    invoke-static {v2}, Lcom/android/phone/PhoneUtils;->setCallMessage(Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/phone/CallNotifier;->updateHdVoiceStatus()V
    ...
    iget-object v6, v6, Lcom/android/phone/PhoneGlobals;->notifiers:[Lcom/android/phone/CallNotifier;
    ...
    const-string v2, "Start ring after the cdma network call was cleared"
    ...
    const-string v2, "Start ring after the gsm network call was cleared"
    ...
    const-string v2, "dissconnect switchHoldingAndActive"
...
.method private onNewRingingConnection(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v1, v7}, Landroid/content/ContextWrapper;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lcom/android/phone/PhoneGlobals;->setCurrentVisibleSimId(I)V
...
.method private onPhoneStateChanged(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v0, v6, v7}, Landroid/content/ContextWrapper;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method private onRingbackTone(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {v0, v5}, Landroid/content/ContextWrapper;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method private updateTotalCallTime(Lcom/android/internal/telephony/Connection;)V
    ...
    invoke-virtual {v1, v9, v0, v2}, Ljava/io/BufferedOutputStream;->write([BII)V
    :try_end_6
    ...
    :try_start_9
    invoke-virtual {v2, v9, v0, v1}, Ljava/io/BufferedInputStream;->read([BII)I
...
.method public onCdmaCallWaitingReject()V
    ...
    const-string v11, "onCdmaCallWaitingReject - presentation : "
    ...
    invoke-static {v0, v10, v11}, Lcom/android/phone/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    const-string v11, "onCdmaCallWaitingReject - checkCnapSpecialCases - presentation : "
...
.method public resetAudioStateAfterDisconnect()V
    ...
    invoke-static {v0, v3, v4}, Lcom/android/phone/PhoneUtils;->turnOnSpeaker(Landroid/content/Context;ZZ)V
...
.method public updateHdVoiceStatus()V
    .locals 3
    ...
    const-string v2, "updateHdVoiceStatus - mCM.getState() : "
