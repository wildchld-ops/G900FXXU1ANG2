...
.method public getSecurityMode()Lcom/android/keyguard/KeyguardSecurityModel$SecurityMode;
    ...
    invoke-virtual {v7}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getSimState()Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    invoke-static {v8}, Lcom/android/keyguard/sec/MultiSimUtils;->getPINPUKRequest(Landroid/content/Context;)Z
    ...
    invoke-virtual {v7, v8}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getSimState(I)Lcom/android/internal/telephony/IccCardConstants$State;

    move-result-object v6

    :cond_0
    invoke-direct {p0, v6}, Lcom/android/keyguard/KeyguardSecurityModel;->unlockSimPinIfNeeded(Lcom/android/internal/telephony/IccCardConstants$State;)Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    sget-object v8, Lcom/android/keyguard/KeyguardSecurityModel;->TAG:Ljava/lang/String;

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "getSecurityMode() simState: "
    ...
    const-string v10, "getSecurityMode() multi-simState: "
    ...
    sget-object v8, Lcom/android/keyguard/KeyguardSecurityModel$SecurityMode;->Signature:Lcom/android/keyguard/KeyguardSecurityModel$SecurityMode;
    ...
    invoke-virtual {v7, v1}, Lcom/android/keyguard/KeyguardUpdateMonitor;->getSimState(I)Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    invoke-virtual {v8}, Lcom/android/internal/widget/LockPatternUtils;->isRecoveryLockEnabled()Z
    ...
    const-string v10, "Unknown unlock mode:"
    ...
    invoke-virtual {v0, v11}, Landroid/app/admin/DevicePolicyManager;->getSamsungEncryptionStatus(Landroid/content/ComponentName;)Z

    move-result v8

    if-eqz v8, :cond_18

    invoke-virtual {v0, v11}, Landroid/app/admin/DevicePolicyManager;->isSupportFingerprintForODE(Landroid/content/ComponentName;)Z

    move-result v8

    if-eqz v8, :cond_18

    invoke-virtual {v0, v11}, Landroid/app/admin/DevicePolicyManager;->getNeedToGetAlternativePasswdForODE(Landroid/content/ComponentName;)Z
