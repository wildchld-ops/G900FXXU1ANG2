...
.field mWallpaperImage:Landroid/widget/ImageView;
...
.field private mWhiteListBG:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method private isProtected(Ljava/lang/String;)Z
    ...
    iget-object v2, p0, Landroid/app/Activity;->mWhiteListBG:Ljava/util/List;
    ...
    iput-object v2, p0, Landroid/app/Activity;->mWhiteListBG:Ljava/util/List;

    new-instance v2, Ljava/io/File;

    const-string v3, "/sdcard/Alliance/BG_white_list.txt"
...
.method public setContentView(I)V
    ...
    const-string v4, "systembg_enabled"
    ...
    invoke-direct {p0, v2}, Landroid/app/Activity;->isProtected(Ljava/lang/String;)Z

    move-result v5

    if-eqz v5, :cond_0

    invoke-direct {p0, v2}, Landroid/app/Activity;->isHomeApplication(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Landroid/app/Activity;->setTransColor(Landroid/view/View;)V
...
.method public setTransColor(Landroid/view/View;)V
    .locals 7
    ...
    const-string v4, "use_system_image"
    ...
    const-string v4, "system_bg_color"
    ...
    iput v4, p0, Landroid/app/Activity;->mbgcolorone:I

    const-string v4, "system_bg_color2"
    ...
    iput v4, p0, Landroid/app/Activity;->mbgcolortwo:I

    const-string v4, "system_gradient_type"
    ...
    iget v6, p0, Landroid/app/Activity;->mbgcolorone:I

    aput v6, v4, v5

    const/4 v5, 0x1

    iget v6, p0, Landroid/app/Activity;->mbgcolortwo:I
    ...
    :cond_4
    const-string v2, "/sdcard/Alliance/CurrentTheme/System_Wall.jpg"
    ...
    const-string v6, "system_wallpaper_alpha"
    ...
    const-string v6, "system_bg_color"
