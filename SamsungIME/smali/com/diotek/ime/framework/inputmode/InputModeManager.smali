...
.method public getValidMMCodes(II)[I
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->getContext()Landroid/content/Context;

    move-result-object v27

    invoke-static/range {v27 .. v27}, Lcom/sec/android/inputmethod/plugin/ocr/OCRHelper;->getInstance(Landroid/content/Context;)Lcom/sec/android/inputmethod/plugin/ocr/OCRHelper;
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/sec/android/inputmethod/plugin/ocr/OCRHelper;->getOCRPackageInfo()Landroid/content/pm/PackageInfo;

    move-result-object v24

    if-eqz v24, :cond_0

    invoke-virtual/range {v23 .. v23}, Lcom/sec/android/inputmethod/plugin/ocr/OCRHelper;->isEnabled()Z
    ...
    const-string v28, "set case 1 : mIsEnableOCR = false"
    ...
    sget-object v27, Lcom/diotek/ime/framework/inputmode/InputModeManager;->buildcarrier:Ljava/lang/String;

    const-string v28, "ks02"
    ...
    :goto_1
    sget-boolean v27, Lcom/diotek/ime/framework/util/Debug;->DEBUG:Z
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->isRegisteredOcrSIPTextReceiver()Z
    ...
    const-string v28, "getValidMMCodes - registerOcrSIPTextReceiver"
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->registerOcrSIPTextReceiver()V
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->isMultiwindowPhone()Z
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/PrivateImeOptionsController;->isDisableHWRInput()Z
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->getCurrentInputEditorInfo()Landroid/view/inputmethod/EditorInfo;
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/PrivateImeOptionsController;->getInputType()I
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->isUsePopupKeyboard()Z
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->getCurrentInputScriptype()I
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->isJapaneseLanguageSelected()Z
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/PrivateImeOptionsController;->isDisableEmoticonInput()Z
    ...
    invoke-static/range {v27 .. v27}, Lcom/sec/android/inputmethod/accessibility/AccessibilityMagnificationCompat;->isEnabledMagnificationGesture(Landroid/content/Context;)Z
    ...
    invoke-virtual/range {v27 .. v27}, Landroid/app/KeyguardManager;->isKeyguardLocked()Z
    ...
    invoke-interface/range {v27 .. v27}, Lcom/diotek/ime/framework/common/InputManager;->useOnlyNormalKeyboard()Z
    ...
    invoke-virtual/range {v27 .. v27}, Lcom/diotek/ime/framework/sidesync/SideSyncManager;->isSideSyncWorkingOnSink()Z
    ...
    const-string v28, "set case 2 : mIsEnableOCR = true"
