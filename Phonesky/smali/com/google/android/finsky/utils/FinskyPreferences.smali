...
.field public static final dailyHygieneHoldoffExpirationTimestampMs:Lcom/google/android/finsky/config/PreferenceFile$SharedPreference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/android/finsky/config/PreferenceFile$SharedPreference",
            "<",
...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v4, v5}, Lcom/google/android/finsky/config/PreferenceFile;->value(Ljava/lang/String;Ljava/lang/Integer;)Lcom/google/android/finsky/config/PreferenceFile$SharedPreference;
    ...
    sget-object v4, Lcom/google/android/finsky/utils/FinskyPreferences;->sPrefs:Lcom/google/android/finsky/config/PreferenceFile;
    ...
    const-string v4, "had-pre-js-auto-update-settings"
    ...
    const-string v4, "update-migration-dialog-accepted"
    ...
    const-string v4, "update-migration-dialog-times-shown-count"
    ...
    const-string v4, "last-update-migration-dialog-times-shown"

    invoke-static {v6, v7}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v5

    invoke-virtual {v0, v4, v5}, Lcom/google/android/finsky/config/PreferenceFile;->value(Ljava/lang/String;Ljava/lang/Long;)Lcom/google/android/finsky/config/PreferenceFile$SharedPreference;
    ...
    const-string v4, "play-games-install-suggestion-shown-count"
    ...
    const-string v4, "play-games-install-suggestion-last-time-shown"
    ...
    const-string v5, "device-config-token"
    ...
    const-string v5, "gcm-registration-id-on-server"
    ...
    const-string v4, "dailyhygiene-failed"
    ...
    const-string v4, "dailyhygiene-lastsuccess"
    ...
    const-string v4, "dailyhygiene-holdoff-expiration-timestamp-ms"
    ...
    sput-object v0, Lcom/google/android/finsky/utils/FinskyPreferences;->dailyHygieneHoldoffExpirationTimestampMs:Lcom/google/android/finsky/config/PreferenceFile$SharedPreference;
    ...
    const-string v4, "installation-replication-retries"
    ...
    const-string v5, "dfe-notification-pending-acks"
    ...
    const-string v4, "last-replicated-database-version"
    ...
    const-string v4, "replicated-system-apps-hash"

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v5

    invoke-virtual {v0, v4, v5}, Lcom/google/android/finsky/config/PreferenceFile;->prefixPreference(Ljava/lang/String;Ljava/lang/Integer;)Lcom/google/android/finsky/config/PreferenceFile$PrefixSharedPreference;
    ...
    const-string v4, "last-tos-token"

    const-string v5, ""

    invoke-virtual {v0, v4, v5}, Lcom/google/android/finsky/config/PreferenceFile;->prefixPreference(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/finsky/config/PreferenceFile$PrefixSharedPreference;
    ...
    const-string v4, "replicated-account-apps-hash:"
    ...
    const-string v4, "check-promo-offers"

    invoke-static {v3}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v5

    invoke-virtual {v0, v4, v5}, Lcom/google/android/finsky/config/PreferenceFile;->prefixPreference(Ljava/lang/String;Ljava/lang/Boolean;)Lcom/google/android/finsky/config/PreferenceFile$PrefixSharedPreference;
    ...
    const-string v4, "has-fop-last-update-ms"

    invoke-static {v6, v7}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v5

    invoke-virtual {v0, v4, v5}, Lcom/google/android/finsky/config/PreferenceFile;->prefixPreference(Ljava/lang/String;Ljava/lang/Long;)Lcom/google/android/finsky/config/PreferenceFile$PrefixSharedPreference;
    ...
    const-string v4, "prompt-for-fop-num-snoozed"
    ...
    const-string v4, "prompt-for-fop-last-snooze-timestamp-ms"
    ...
    const-string v4, "prompt-for-fop-num-dialog-impressions"
    ...
    const-string v4, "prompt-for-fop-num-fop-selector-impressions"
    ...
    const-string v4, "prompt-for-fop-fop-added"
    ...
    const-string v4, "last-gaia-auth-timestamp"
    ...
    const-string v5, "gaia-auth-opt-out"

    sget-object v0, Lcom/google/android/finsky/config/G;->passwordPurchaseRestrictOnByDefault:Lcom/google/android/finsky/config/GservicesValue;
    ...
    invoke-virtual {v4, v5, v0}, Lcom/google/android/finsky/config/PreferenceFile;->prefixPreference(Ljava/lang/String;Ljava/lang/Boolean;)Lcom/google/android/finsky/config/PreferenceFile$PrefixSharedPreference;
    ...
    const-string v5, "experiment-list"

    move-object v0, v1

    check-cast v0, Ljava/lang/String;

    invoke-virtual {v4, v5, v0}, Lcom/google/android/finsky/config/PreferenceFile;->prefixPreference(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/finsky/config/PreferenceFile$PrefixSharedPreference;
    ...
    const-string v5, "autoAcquireTags"
    ...
    const-string v4, "my-library-widget-top-affinities"

    const-string v5, ""

    invoke-virtual {v0, v4, v5}, Lcom/google/android/finsky/config/PreferenceFile;->value(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/finsky/config/PreferenceFile$SharedPreference;
    ...
    const-string v4, "my-library-widget-bottom-affinities"
    ...
    const-string v4, "my-library-widget-left-affinities"
    ...
    const-string v4, "my-library-widget-right-affinities"
    ...
    const-string v4, "download-manager-uses-froyo-strings"
    ...
    const-string v4, "accepted-plus-reviews"
    ...
    const-string v4, "nlp-cleanup-config-id"
    ...
    const-string v4, "nlp-cleanup-config-holdoff-until-boot"
    ...
    const-string v4, "nlp-cleanup-config-holdoff-after-install"
    ...
    const-string v4, "libraryWidgetData"

    check-cast v1, Ljava/lang/String;

    invoke-virtual {v0, v4, v1}, Lcom/google/android/finsky/config/PreferenceFile;->prefixPreference(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/finsky/config/PreferenceFile$PrefixSharedPreference;
    ...
    invoke-virtual {v0, v1, v4}, Lcom/google/android/finsky/config/PreferenceFile;->value(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/finsky/config/PreferenceFile$SharedPreference;
    ...
    invoke-virtual {v0, v1, v4}, Lcom/google/android/finsky/config/PreferenceFile;->value(Ljava/lang/String;Ljava/lang/Integer;)Lcom/google/android/finsky/config/PreferenceFile$SharedPreference;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/google/android/finsky/config/PreferenceFile;->value(Ljava/lang/String;Ljava/lang/Boolean;)Lcom/google/android/finsky/config/PreferenceFile$SharedPreference;
