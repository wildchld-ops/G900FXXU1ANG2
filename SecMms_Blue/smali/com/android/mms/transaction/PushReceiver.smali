...
.method private saveReportToSms(Landroid/content/Context;IILjava/lang/String;)V
    ...
    const-string v14, "saveReportToSms()"
    ...
    invoke-static {v0, v1}, Lcom/android/mms/transaction/PushReceiver;->getMmsDeliveryReportText(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v0, v13}, Lcom/android/mms/data/Contact;->get(Ljava/lang/String;Z)Lcom/android/mms/data/Contact;

    move-result-object v13

    invoke-virtual {v13}, Lcom/android/mms/data/Contact;->getNameAndNumber()Ljava/lang/String;
    ...
    invoke-static {v0, v13, v14, v12}, Landroid/database/sqlite/SqliteWrapper;->insert(Landroid/content/Context;Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    invoke-virtual {v13, v0, v9, v10}, Lcom/android/mms/util/Recycler;->deleteOldMessagesByThreadId(Landroid/content/Context;J)V
    ...
    invoke-static {v0, v6, v13, v14}, Lcom/android/mms/transaction/MessagingNotification;->blockingUpdateNewMessageIndicator(Landroid/content/Context;Landroid/net/Uri;ZI)V

    move-object/from16 v0, p1

    invoke-static {v0, v6}, Lcom/android/mms/transaction/MessagingNotification;->updateHistoryForSms(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {v0, v6, v1, v13, v14}, Lcom/android/mms/transaction/MessagingNotification;->updateSmsDataforInternalApp(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-static {v0, v6, v1, v13}, Lcom/android/mms/ui/MessageUtils;->sendNotiToOtherApp(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static/range {p1 .. p1}, Lcom/android/mms/bstairmessage/SAirMessage;->getInstance(Landroid/content/Context;)Lcom/android/mms/bstairmessage/SAirMessage;

    move-result-object v8

    move-object/from16 v0, p1

    invoke-virtual {v8, v0}, Lcom/android/mms/bstairmessage/SAirMessage;->MsgSendSMSToAirMsg(Landroid/content/Context;)V
    ...
    invoke-static {v0, v1}, Lcom/android/mms/transaction/PushReceiver;->getMmsReadReportText(Landroid/content/Context;I)Ljava/lang/String;
