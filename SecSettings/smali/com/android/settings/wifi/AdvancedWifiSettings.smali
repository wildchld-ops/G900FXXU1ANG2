...
.method private initPreferences()V
    ...
    invoke-virtual/range {v44 .. v44}, Landroid/net/wifi/WifiManager;->isWifiEnabled()Z
    ...
    const-string v45, "CscFeature_Common_ConfigLocalSecurityPolicy"
    ...
    const-string v44, "ChinaNalSecurity"
    ...
    const-string v44, "notify_open_networks"
    ...
    const-string v45, "wifi_networks_available_notification_on"
    ...
    :cond_0
    const-string v44, "connect_seamlessly"
    ...
    :cond_1
    const-string v44, "wifi_poor_network_detection"
    ...
    invoke-static/range {v44 .. v44}, Lcom/android/settings/Utils;->locateSmartNetworkSwitch(Landroid/content/Context;)I
    ...
    const v45, 0x7f0904de

    invoke-virtual/range {v44 .. v45}, Landroid/preference/CheckBoxPreference;->setTitle(I)V
    ...
    const-string v46, "wifi_watchdog_poor_network_test_enabled"
    ...
    :cond_2
    :goto_3
    const-string v44, "wifi_scan_always_available"
    ...
    const-string v46, "wifi_scan_always_enabled"
    ...
    const-string v44, "android.credentials.INSTALL_AS_USER"
    ...
    const-string v44, "com.android.certinstaller"

    const-string v45, "com.android.certinstaller.CertInstallerMain"
    ...
    const-string v44, "install_as_uid"
    ...
    const-string v44, "install_credentials"
    ...
    const-string v44, "att_auto_connect"
    ...
    const-string v45, "wlan_permission_available"
    ...
    :cond_4
    :goto_6
    const-string v44, "wifi_cmcc_manual"
    ...
    :cond_5
    const-string v44, "frequency_band"
    ...
    :cond_6
    const-string v44, "ap_list_priority"
    ...
    :cond_7
    const-string v44, "preferred_band"
    ...
    invoke-virtual/range {v44 .. v44}, Landroid/net/wifi/WifiManager;->getWifiDualbandAPConnection()I
    ...
    :cond_8
    :goto_8
    const-string v44, "hidden_aps_by_rssi"
    ...
    invoke-virtual {v15, v0}, Landroid/preference/ListPreference;->setWidgetLayoutResource(I)V
    ...
    const-string v45, "hidden_ap_sinal_strength"
    ...
    :cond_9
    :goto_9
    const-string v44, "hidden_aps_by_ssid"
    ...
    :cond_b
    const-string v44, "wifi_connection_priority_mode"
    ...
    const-string v44, "wifi_connection_settings"
    ...
    const-string v44, "iwlan_enabled_category"
    ...
    :cond_d
    const-string v44, "iwlan_networks"
    ...
    :cond_e
    const-string v44, "add_other_iwlan"
    ...
    :cond_f
    const-string v44, "mwlan_permission_allowed_2"
    ...
    const-string v45, "com.lguplus.common.wificm.mwlan"

    const/16 v46, 0x0

    invoke-virtual/range {v44 .. v46}, Landroid/app/Activity;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;

    move-result-object v22

    const-string v44, "mwlan"
    ...
    const-string v44, "permission_allowed_2"
    ...
    invoke-virtual/range {v44 .. v45}, Landroid/app/Activity;->getPreferences(I)Landroid/content/SharedPreferences;
    ...
    const-string v44, "KEY_LGT_MWLAN_PERMISSION"
    ...
    :cond_10
    :goto_c
    const-string v44, "wifi_cmcc_priority"
    ...
    invoke-virtual/range {v44 .. v45}, Landroid/app/admin/DevicePolicyManager;->getAllowWifi(Landroid/content/ComponentName;)Z
    ...
    const-string v44, "AdvancedWifiSettings"

    new-instance v45, Ljava/lang/StringBuilder;

    invoke-direct/range {v45 .. v45}, Ljava/lang/StringBuilder;-><init>()V

    const-string v46, "allowWifi:     "
    ...
    const-string v44, "wifitimer_hide_navigation_button"

    sget-boolean v45, Lcom/android/settings/wifi/AdvancedWifiSettings;->hideNavigationButton:Z
    ...
    const-string v45, "wifitimer_start_time_checked"
    ...
    const-string v45, "wifitimer_end_time_checked"
    ...
    const-string v44, "com.android.settings.wifi.wifitimer_alarm"

    move-object/from16 v0, v44

    invoke-direct {v4, v0}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string v44, "com.android.settings.wifi.wifisheduler_action_type"
    ...
    const-string v45, "wag_ip_settings"
    ...
    const-string v46, "isHotspot20Disabled..."
    ...
    const-string v45, "INSIDE HOTSPOT2_0"
    ...
    const-string v46, "wifi_hotspot20_enable"
    ...
    const-string v45, "wifi_sleep_policy"
    ...
    const-string v44, "mwlan_enabled_category"
    ...
    const-string v46, "wifitimer_start_time"

    const-string v47, "19:00"

    invoke-interface/range {v45 .. v47}, Landroid/content/SharedPreferences;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v45

    invoke-static/range {v44 .. v45}, Lcom/android/settings/wifi/WifiTimer;->getTimeAmPmFormat(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v46, "wifitimer_end_time"

    const-string v47, "21:00"
    ...
    const v45, 0x7f090442

    invoke-virtual/range {v44 .. v45}, Landroid/preference/Preference;->setSummary(I)V
    ...
    invoke-virtual/range {v44 .. v45}, Landroid/preference/Preference;->setSummary(Ljava/lang/CharSequence;)V
