...
.method public initPref()V
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mDummyDate:Ljava/util/Calendar;
    ...
    check-cast v3, Lcom/android/settings/UnclickablePreference;

    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mHelpPref:Lcom/android/settings/UnclickablePreference;
    ...
    iget-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mHelpPref:Lcom/android/settings/UnclickablePreference;
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mIncomingCallPref:Landroid/preference/CheckBoxPreference;

    iget-object v6, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mIncomingCallPref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mNotificationsPref:Landroid/preference/CheckBoxPreference;

    iget-object v6, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mNotificationsPref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAlarmandTimePref:Landroid/preference/CheckBoxPreference;

    iget-object v6, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAlarmandTimePref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mLedIndicatorPref:Landroid/preference/CheckBoxPreference;

    iget-object v6, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mLedIndicatorPref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAlwaysPref:Landroid/preference/CheckBoxPreference;

    iget-object v6, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAlwaysPref:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAllowedContactsPref:Landroid/preference/ListPreference;
    ...
    invoke-direct {p0, v3}, Lcom/android/settings/dormantmode/DormantmodeSettings;->setAllowListsummery(Ljava/lang/String;)V
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAllowedListPref:Landroid/preference/Preference;

    iget-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAllowedListPref:Landroid/preference/Preference;

    iget-object v6, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAllowedContactsPref:Landroid/preference/ListPreference;
    ...
    const-string v3, "allowed_group"

    invoke-virtual {p0, v3}, Landroid/preference/PreferenceFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v3

    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAllowedGroupPref:Landroid/preference/Preference;
    ...
    const-string v3, "set_time_category"
    ...
    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mSetTimPref:Landroid/preference/PreferenceCategory;
    ...
    new-instance v3, Lcom/android/settings/dormantmode/DormantmodeSettings$3;

    invoke-virtual {p0}, Landroid/app/Fragment;->getActivity()Landroid/app/Activity;

    move-result-object v6

    invoke-direct {v3, p0, v6}, Lcom/android/settings/dormantmode/DormantmodeSettings$3;-><init>(Lcom/android/settings/dormantmode/DormantmodeSettings;Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mSetTimeDialogPref:Landroid/preference/Preference;
    ...
    iget-object v3, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mSetTimPref:Landroid/preference/PreferenceCategory;
    ...
    const-string v3, "allowed_contacts_category"
...
.method updateDormantmodepage()V
    ...
    iget-object v1, p0, Lcom/android/settings/dormantmode/DormantmodeSettings;->mAllowedGroupPref:Landroid/preference/Preference;
