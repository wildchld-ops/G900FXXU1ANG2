...
.method private installCertificateinCCM(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v13, v1, v4}, Ljava/lang/String;->replace(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-direct {v0, v14}, Lcom/android/settings/CredentialStorage;->getPrivateKeyFromBytes([B)Ljava/security/PrivateKey;

    move-result-object v12

    move-object/from16 v0, p0

    invoke-direct {v0, v9}, Lcom/android/settings/CredentialStorage;->getCertificateFromBytes([B)Ljava/security/cert/Certificate;

    move-result-object v8

    move-object/from16 v0, p0

    iget-object v1, v0, Lcom/android/settings/CredentialStorage;->mCCMService:Lcom/sec/enterprise/knox/ccm/IClientCertificateManager;

    const/4 v4, 0x3

    check-cast v12, Ljava/security/interfaces/RSAPrivateKey;
    ...
    invoke-direct {v0, v12, v5}, Lcom/android/settings/CredentialStorage;->getFormattedPrivateKey(Ljava/security/interfaces/RSAPrivateKey;Ljava/security/interfaces/RSAPublicKey;)[B

    move-result-object v5

    const/4 v6, 0x0

    invoke-interface/range {v1 .. v6}, Lcom/sec/enterprise/knox/ccm/IClientCertificateManager;->installObjectWithType(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;I[BLjava/lang/String;)Z

    :cond_3
    new-instance v15, Lcom/sec/enterprise/knox/ccm/CertificateProfile;

    invoke-direct {v15}, Lcom/sec/enterprise/knox/ccm/CertificateProfile;-><init>()V

    const/4 v1, 0x1

    iput-boolean v1, v15, Lcom/sec/enterprise/knox/ccm/CertificateProfile;->isCSRResponse:Z
    ...
    :goto_0
    iput-boolean v1, v15, Lcom/sec/enterprise/knox/ccm/CertificateProfile;->allowWiFi:Z

    iput-object v3, v15, Lcom/sec/enterprise/knox/ccm/CertificateProfile;->alias:Ljava/lang/String;

    const/4 v1, 0x1

    iput-boolean v1, v15, Lcom/sec/enterprise/knox/ccm/CertificateProfile;->allowAllPackages:Z
    ...
    invoke-interface {v1, v2, v15, v4, v5}, Lcom/sec/enterprise/knox/ccm/IClientCertificateManager;->installCertificate(Landroid/app/enterprise/ContextInfo;Lcom/sec/enterprise/knox/ccm/CertificateProfile;[BLjava/lang/String;)Z
    ...
    const-string v4, "Error installing certificate into CCM, installCertificate returned false"
    ...
    const-string v4, "Error installing certificate into CCM"
...
.method private installIfAvailable()V
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/CredentialStorage;->installCertificateinCCM(Landroid/os/Bundle;)V
