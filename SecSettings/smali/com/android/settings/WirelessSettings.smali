...
.method static synthetic access$600(Lcom/android/settings/WirelessSettings;)Landroid/preference/Preference;
    .locals 1
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v6, "mButtonSmartNetworkEnabled != null"
    ...
    const-string v6, "CscFeature_Clock_ExclusiveEnablingAutoPowerSetting"
    ...
    const-string v6, "auto_power_on_off_mode"
    ...
    invoke-direct {v1, v7, v6}, Lcom/android/settings/AirplaneModeEnabler;-><init>(Landroid/content/Context;Landroid/preference/CheckBoxPreference;)V
    ...
    iget-object v6, p0, Lcom/android/settings/WirelessSettings;->mEnableSwitchWifiAp:Landroid/preference/SwitchPreference;
    ...
    iget-object v6, p0, Lcom/android/settings/WirelessSettings;->mWifiApSettings:Landroid/preference/PreferenceScreen;
    ...
    invoke-virtual {v0, v6}, Landroid/preference/Preference;->setDependency(Ljava/lang/String;)V
    ...
    const-string v6, "nearby_settings"
    ...
    :cond_10
    invoke-virtual {p0, v7}, Lcom/android/settings/WirelessSettings;->getNearbyEnabler(Landroid/app/Activity;)Lcom/android/settings/nearby/NearbyEnabler;
    ...
    const-string v9, "nfc_setting_vzw"
    ...
    iget-object v1, p0, Lcom/android/settings/WirelessSettings;->mNfcDefaultTransaction:Landroid/preference/PreferenceScreen;

    invoke-virtual {v0, v1}, Landroid/preference/PreferenceCategory;->removePreference(Landroid/preference/Preference;)Z

    :cond_1d
    iput-object v11, p0, Lcom/android/settings/WirelessSettings;->mNfcDefaultTransaction:Landroid/preference/PreferenceScreen;
    ...
    const-string v9, "RCS availability: "
    ...
    invoke-direct {v1, v7, v0}, Lcom/android/settings/rcs/RcsSettings;-><init>(Landroid/content/Context;Landroid/preference/PreferenceScreen;)V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v3, p0, Lcom/android/settings/WirelessSettings;->mSmsApplicationPreference:Lcom/android/settings/SmsListPreference;

    invoke-virtual {v3}, Lcom/android/settings/SmsListPreference;->getEntryValues()[Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v2, v5}, Lcom/android/settings/WirelessSettings;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
