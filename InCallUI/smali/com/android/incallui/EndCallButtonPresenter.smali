...
.method public updateEndCallButtonDisplayInfo(I)V
    ...
    check-cast v8, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;
    ...
    invoke-virtual {v9, p1}, Lcom/android/incallui/ContactInfoCache;->getInfo(I)Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;
    ...
    const-string v12, "lock_pcw_enabled"
    ...
    iget-boolean v2, v1, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->contactExists:Z

    iget v9, v1, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->presentation:I

    sget v12, Lcom/android/services/telephony/common/Call;->PRESENTATION_RESTRICTED:I

    if-eq v9, v12, :cond_3

    iget v9, v1, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->presentation:I

    sget v12, Lcom/android/services/telephony/common/Call;->PRESENTATION_UNKNOWN:I
    ...
    invoke-static {p0, v9, v3}, Lcom/android/incallui/Log;->v(Ljava/lang/Object;Ljava/lang/String;Z)V

    const-string v9, "contactExists : "

    invoke-static {p0, v9, v2}, Lcom/android/incallui/Log;->v(Ljava/lang/Object;Ljava/lang/String;Z)V

    const-string v9, "isNumberExists : "

    invoke-static {p0, v9, v4}, Lcom/android/incallui/Log;->v(Ljava/lang/Object;Ljava/lang/String;Z)V

    const-string v9, "islockPcw : "

    invoke-static {p0, v9, v5}, Lcom/android/incallui/Log;->v(Ljava/lang/Object;Ljava/lang/String;Z)V
    ...
    :goto_2
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->showCreateContact(Z)V
    ...
    :goto_3
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->showUpdateExisting(Z)V
    ...
    :goto_4
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->showViewContact(Z)V
    ...
    :goto_5
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->enableCreateContact(Z)V
    ...
    :goto_6
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->enableUpdateExisting(Z)V
    ...
    :goto_7
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->enableViewContact(Z)V
    ...
    :goto_8
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->enableVoiceCall(Z)V
    ...
    :goto_9
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->enableVideoCall(Z)V
    ...
    :goto_a
    invoke-interface {v8, v9}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->enableSendMessage(Z)V
    ...
    invoke-static {v9}, Lcom/android/incallui/rcs/RcsShareUI;->disconnect(Landroid/content/Context;)V
    ...
    :goto_b
    invoke-interface {v8, v10}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->enableIpCall(Z)V

    :cond_6
    invoke-interface {v8}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->updateEndCallButtonDrawable()V

    const-string v9, "emergency_find_lost_phone"
    ...
    invoke-static {v7}, Lcom/android/incallui/InCallUtils;->isFindServiceNumber(Ljava/lang/String;)Ljava/lang/Boolean;
    ...
    invoke-virtual {v9}, Lcom/android/incallui/CallCommandClient;->isFindService()Ljava/lang/Boolean;
    ...
    :cond_7
    invoke-interface {v8, v11}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->enableAllButtons(Z)V

    invoke-interface {v8, v11}, Lcom/android/incallui/EndCallButtonPresenter$CallButtonUi;->showAllButtons(Z)V

    goto/16 :goto_0

    :cond_8
    iget-object v9, v1, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->number:Ljava/lang/String;
...
.method public videoCallClicked()V
    ...
    invoke-virtual {v2}, Lcom/android/incallui/CallCommandClient;->setCallManagerAudioMode()V
...
.method public voiceCallClicked()V
    ...
    sget-boolean v3, Lcom/android/incallui/EndCallButtonPresenter;->fromEndcallDriveLink:Z

    if-eqz v3, :cond_2

    const-string v3, "setFromEndButtonDriveLink"

    invoke-virtual {v0, v3, v7}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    sput-boolean v6, Lcom/android/incallui/EndCallButtonPresenter;->fromEndcallDriveLink:Z

    :cond_2
    sget-boolean v3, Lcom/android/incallui/EndCallButtonPresenter;->fromMWEndcallDriveLink:Z

    if-eqz v3, :cond_3

    const-string v3, "setFromMWEndButtonDriveLink"

    invoke-virtual {v0, v3, v7}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    sput-boolean v6, Lcom/android/incallui/EndCallButtonPresenter;->fromMWEndcallDriveLink:Z
    ...
    invoke-virtual {v3}, Lcom/android/incallui/CallCommandClient;->setCallManagerAudioMode()V
