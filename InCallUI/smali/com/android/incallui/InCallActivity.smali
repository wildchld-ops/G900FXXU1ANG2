...
.method public answeringMode()V
    ...
    invoke-interface {v1, v3}, Lcom/android/incallui/CallCardPresenter$CallCardUi;->showExtraVolButton(Z)V
...
.method public displayDialpad(ZZ)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/incallui/InCallActivity;->setPrimaryCallElapsedTimeForDialpad(Ljava/lang/String;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v3, v6}, Lcom/android/incallui/InCallActivity;->requestSystemKeyEvent(IZ)Z

    invoke-direct {p0, v7, v6}, Lcom/android/incallui/InCallActivity;->requestSystemKeyEvent(IZ)Z

    const/16 v3, 0xbb

    invoke-direct {p0, v3, v6}, Lcom/android/incallui/InCallActivity;->requestSystemKeyEvent(IZ)Z

    invoke-direct {p0, v7}, Lcom/android/incallui/InCallActivity;->isSystemKeyEventRequested(I)Z

    move-result v3

    iput-boolean v3, p0, Lcom/android/incallui/InCallActivity;->mLocked:Z
...
.method protected onPause()V
    ...
    iput-boolean v6, p0, Lcom/android/incallui/InCallActivity;->mIsForegroundActivity:Z

    iget-object v3, p0, Lcom/android/incallui/InCallActivity;->mPowerManager:Landroid/os/PowerManager;
    ...
    iput-boolean v6, p0, Lcom/android/incallui/InCallActivity;->mIsForegroundActivityForProximity:Z
    ...
    iget-object v3, p0, Lcom/android/incallui/InCallActivity;->mStatusBarManager:Landroid/app/StatusBarManager;

    invoke-virtual {v3, v6}, Landroid/app/StatusBarManager;->setTransGradationMode(Z)V
    ...
    const-string v3, "[DRIVELINK] REQUESTSYSTEMKEYEVENT FALSE in pause"
    ...
    iget-object v4, p0, Lcom/android/incallui/InCallActivity;->mDomesticOtaStart:Ljava/lang/String;
    ...
    invoke-direct {p0, v8, v6}, Lcom/android/incallui/InCallActivity;->requestSystemKeyEvent(IZ)Z

    invoke-direct {p0, v9, v6}, Lcom/android/incallui/InCallActivity;->requestSystemKeyEvent(IZ)Z

    invoke-direct {p0, v10, v6}, Lcom/android/incallui/InCallActivity;->requestSystemKeyEvent(IZ)Z

    const-string v3, "resume mDomesticOtaStart StatusBarManager.DISABLE_NONE in pause"
    ...
    const-string v3, "resume MissingPhoneLock TRUE "
    ...
    invoke-virtual {p0, v3}, Lcom/android/incallui/InCallActivity;->dismissKeyguard(Z)V

    invoke-virtual {p0, v6}, Lcom/android/incallui/InCallActivity;->updateAppSwitchSystemKeyEvent(Z)V
    ...
    invoke-virtual {v3, v4}, Lcom/android/incallui/DialpadFragment;->onDialerKeyUp(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v3, v6}, Lcom/android/incallui/InCallPresenter;->onUiShowing(Z)V
    ...
    invoke-static {v7}, Lcom/android/incallui/rcs/RcsShareUI;->unRegisterRcsObserver(I)V
...
.method protected onStart()V
    ...
    invoke-virtual {p0, v5}, Landroid/content/ContextWrapper;->sendBroadcast(Landroid/content/Intent;)V
