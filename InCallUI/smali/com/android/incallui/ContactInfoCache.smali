...
.method private findInfoQueryComplete(Lcom/android/services/telephony/common/CallIdentification;Lcom/android/incallui/CallerInfo;ZZ)V
    ...
    invoke-static {v0, v1, v8}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)I
...
.method public static populateCacheEntry(Landroid/content/Context;Lcom/android/incallui/CallerInfo;Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;IZ)V
    ...
    invoke-static/range {v19 .. v19}, Landroid/telephony/PhoneNumberUtils;->isUriNumber(Ljava/lang/String;)Z
    ...
    :cond_0
    const-string v25, "emergency_3lm"
    ...
    sget-object v25, Lcom/android/incallui/ContactInfoCache;->TAG:Ljava/lang/String;

    new-instance v26, Ljava/lang/StringBuilder;

    invoke-direct/range {v26 .. v26}, Ljava/lang/StringBuilder;-><init>()V

    const-string v27, "  ==> no name *or* number! displayName = "
    ...
    invoke-static/range {v25 .. v26}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :goto_0
    const-string v25, "cnap_supplementary_service"
    ...
    const-string v25, "ims_call_message"
    ...
    :cond_3
    const-string v25, "cdnip_supplementary_service"
    ...
    :cond_5
    const-string v25, "emergency_find_lost_phone"
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/incallui/InCallUtils;->changeNameForSKT(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_6
    const-string v25, "roaming_auto_dial"
    ...
    const-string v27, "in roaming area - display rad number : "
    ...
    const-string v25, "country_detector"
    ...
    invoke-virtual/range {v26 .. v26}, Landroid/location/Country;->getCountryIso()Ljava/lang/String;
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/incallui/InCallUtils;->changeNameForSKTRAD(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v27, "in roaming area - display number is "
    ...
    :cond_9
    sget v25, Lcom/android/services/telephony/common/Call;->PRESENTATION_ALLOWED:I
    ...
    const-string v27, "  ==> presentation not allowed! displayName = "
    ...
    const-string v27, "  ==> cnapName available: displayName \'"
    ...
    const-string v27, "\', displayNumber \'"
    ...
    const-string v27, "Geodescrption: "
    ...
    const-string v25, "abbreviated_dialing_codes_enable"
    ...
    :cond_d
    const-string v25, "yellowpage_callerid_info"
    ...
    const-string v27, "populateCacheEntry yellowPageName:"
    ...
    :cond_f
    const-string v25, "fdn_contact_search"
    ...
    const-string v27, "populateCacheEntry getNameFromFDN:"
    ...
    :cond_10
    const-string v25, "feature_ltn_sdnname_display"
    ...
    const-string v27, "populateCacheEntry getNameFromSDN:"
    ...
    const-string v27, "  ==>  no name; falling back to number: displayNumber \'"
    ...
    const-string v27, "\', displayLocation \'"
    ...
    const-string v27, "  ==> valid name, but presentation not allowed! displayName = "
    ...
    const-string v27, "  ==>  name is present in CallerInfo: displayName \'"
    ...
    const-string v26, "in roaming area - display rad number is null"

    const/16 v27, 0x1

    invoke-static/range {v25 .. v27}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)I
...
.method public findInfo(Lcom/android/services/telephony/common/CallIdentification;ZLcom/android/incallui/ContactInfoCache$ContactInfoCacheCallback;)V
    ...
    invoke-static {v8, v5, v6}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    const-string v8, "The cache is not used."

    invoke-static {v5, v8}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v7, "If the entry already exists, add callback"

    invoke-static {v5, v7, v6}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    const-string v7, "If no other callbacks are in flight, we\'re done."
    ...
    invoke-static {v5, v8, v6}, Lcom/android/incallui/Log;->d(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    invoke-static {v5, p1, v6}, Lcom/android/incallui/CallerInfoUtils;->getCallerInfoForCall(Landroid/content/Context;Lcom/android/services/telephony/common/CallIdentification;Lcom/android/incallui/CallerInfoAsyncQuery$OnQueryCompleteListener;)Lcom/android/incallui/CallerInfo;
    ...
    invoke-direct {p0, p1, v3, p2, v7}, Lcom/android/incallui/ContactInfoCache;->findInfoQueryComplete(Lcom/android/services/telephony/common/CallIdentification;Lcom/android/incallui/CallerInfo;ZZ)V
