...
.method public onDisconnect(Lcom/android/services/telephony/common/Call;)V
    ...
    invoke-static {v5}, Lcom/android/incallui/InCallUtils;->setHoldCallState(Z)V
...
.method public onIncomingCall(Lcom/android/services/telephony/common/Call;)V
    ...
    iget-object v10, p0, Lcom/android/incallui/InCallPresenter;->mInCallActivity:Lcom/android/incallui/InCallActivity;
    ...
    invoke-virtual {v10, v13}, Lcom/android/incallui/InCallActivity;->updateScreenType(Landroid/content/res/Configuration;)Z
    ...
    :goto_1
    invoke-static {v10}, Lcom/android/incallui/InCallUtils;->setChangingOrientation(Z)V
    ...
    invoke-virtual {p0, v10}, Lcom/android/incallui/InCallPresenter;->setSimIdToDisplay(I)V
    ...
    invoke-direct {p0, v10}, Lcom/android/incallui/InCallPresenter;->startOrFinishUi(Lcom/android/incallui/InCallPresenter$InCallState;)Lcom/android/incallui/InCallPresenter$InCallState;
    ...
    invoke-virtual {v10}, Lcom/android/incallui/InCallPresenter$InCallState;->isIncoming()Z

    move-result v10

    if-nez v10, :cond_5

    invoke-direct {p0, p1, v11}, Lcom/android/incallui/InCallPresenter;->manageAirMotion(Lcom/android/services/telephony/common/Call;Z)V
    ...
    const-string v10, "bring_the_device_to_ear_to_accept"
    ...
    invoke-static {v10}, Lcom/android/incallui/InCallUtils;->isAnsweringBringToEar(Landroid/content/Context;)Z
    ...
    invoke-virtual {v10, v12}, Lcom/android/incallui/InCallActivity;->displayManageConferencePanel(Z)V
...
.method public setUp(Landroid/content/Context;Lcom/android/incallui/CallList;Lcom/android/incallui/AudioModeProvider;)V
    ...
    invoke-virtual {v4, v6}, Lcom/android/incallui/vt/VideoCallManager;->initialize(Landroid/content/Context;)V
    ...
    iget-object v6, p0, Lcom/android/incallui/InCallPresenter;->mKidsModeBroadcastReceiver:Lcom/android/incallui/InCallPresenter$KidsModeBroadcastReceiver;

    invoke-virtual {v4, v6, v1, v7, v7}, Landroid/content/ContextWrapper;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    iget-object v6, p0, Lcom/android/incallui/InCallPresenter;->mTPhoneBroadcastReceiver:Lcom/android/incallui/InCallPresenter$TPhoneBroadcastReceiver;

    invoke-virtual {v4, v6, v3}, Landroid/content/ContextWrapper;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    iget-object v6, p0, Lcom/android/incallui/InCallPresenter;->mMediaShareReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v4, v6, v2}, Landroid/content/ContextWrapper;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    iget-object v6, p0, Lcom/android/incallui/InCallPresenter;->mPSBarringEvenReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v4, v6, v0}, Landroid/content/ContextWrapper;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
