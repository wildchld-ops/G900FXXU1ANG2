...
.method private declared-synchronized bindSSOInterfacesSync(Landroid/app/enterprise/ContextInfo;ILjava/lang/String;)Landroid/app/enterprise/EnterpriseResponseData;
    ...
    const-string v7, ">>>> bindSSOInterfacesSync"
    ...
    invoke-direct {p0, v6, v7}, Lcom/android/server/enterprise/container/EnterpriseSSOPolicy;->isExistingOrFirstClient(II)Z
    ...
    :cond_0
    sget-object v6, Lcom/android/server/enterprise/container/EnterpriseSSOPolicy;->mSSOTypeMap:Ljava/util/Map;
    ...
    check-cast v3, Lcom/android/server/enterprise/utils/SSOTypeMapData;

    invoke-virtual {v3}, Lcom/android/server/enterprise/utils/SSOTypeMapData;->getSSOInterface()Lcom/sec/android/service/singlesignon/IEnterpriseSecurityManager2;

    move-result-object v6

    if-eqz v6, :cond_2

    invoke-virtual {v3}, Lcom/android/server/enterprise/utils/SSOTypeMapData;->getContainerId()I

    move-result v6

    if-ne v6, p2, :cond_2

    invoke-virtual {v3}, Lcom/android/server/enterprise/utils/SSOTypeMapData;->getPackageName()Ljava/lang/String;
    ...
    const-string v7, "bindSSOInterfacesSync() - already bound"
    ...
    invoke-direct {p0, v6, v7, p3}, Lcom/android/server/enterprise/container/EnterpriseSSOPolicy;->bindSSOInterfaces(IILjava/lang/String;)I
    ...
    const-string v8, "bindSSOInterfacesSync() containerId = "
    ...
    const-string v8, " /  result of sso binding : "
    ...
    const-string v8, " bindSSOInterfacesSync: adding cilentHandle : "
    ...
    invoke-direct {p0, v6}, Lcom/android/server/enterprise/container/EnterpriseSSOPolicy;->removeClintEntry(I)V
    ...
    const-string v8, " bindSSOInterfacesSync: already present cilentHandle : "
...
.method private declared-synchronized bindSSOInterfacesWithClientsList()V
    .locals 15

    monitor-enter p0

    :try_start_0
    const-string v12, "EnterpriseSSOPolicyService"

    const-string v13, ">>>> bindSSOInterfacesWithClientsList"

    invoke-static {v12, v13}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v12, p0, Lcom/android/server/enterprise/container/EnterpriseSSOPolicy;->clientsList:Ljava/util/ArrayList;

    if-nez v12, :cond_1

    const-string v12, "EnterpriseSSOPolicyService"

    const-string v13, "clientsList is null"
    ...
    const-string/jumbo v13, "token count is not enough"
    ...
    const-string v14, "Parse clientsList - clientUid is : "
    ...
    const-string v14, "Parse clientsList - ContainerId is : "
    ...
    const-string v14, "Parse clientsList - sso is : "
    ...
    sget-object v12, Lcom/android/server/enterprise/container/EnterpriseSSOPolicy;->mSSOTypeMap:Ljava/util/Map;
    ...
    check-cast v6, Lcom/android/server/enterprise/utils/SSOTypeMapData;

    invoke-virtual {v6}, Lcom/android/server/enterprise/utils/SSOTypeMapData;->getSSOInterface()Lcom/sec/android/service/singlesignon/IEnterpriseSecurityManager2;

    move-result-object v12

    if-eqz v12, :cond_4

    invoke-virtual {v6}, Lcom/android/server/enterprise/utils/SSOTypeMapData;->getContainerId()I

    move-result v12

    if-ne v12, v3, :cond_4

    invoke-virtual {v6}, Lcom/android/server/enterprise/utils/SSOTypeMapData;->getPackageName()Ljava/lang/String;
    ...
    const-string v13, "Parse clientsList - SSO Service is already bound: "
    ...
    const-string v13, "clientUid is contained, but not matched, try bindSSOInterfaces"

    invoke-static {v12, v13}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0, v2, v3, v7}, Lcom/android/server/enterprise/container/EnterpriseSSOPolicy;->bindSSOInterfaces(IILjava/lang/String;)I
    ...
    const-string v14, "bindSSOInterfaces result : "
...
.method public deleteSSOWhiteList(Landroid/app/enterprise/ContextInfo;ILjava/lang/String;Ljava/lang/String;Ljava/util/List;)Landroid/app/enterprise/EnterpriseResponseData;
    ...
    :cond_1
    invoke-direct {p0}, Lcom/android/server/enterprise/container/EnterpriseSSOPolicy;->bindSSOInterfacesWithClientsList()V
