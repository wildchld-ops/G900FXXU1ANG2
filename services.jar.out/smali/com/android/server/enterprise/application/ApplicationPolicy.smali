...
.method private isApplicationInstallationEnabledInternal(ILjava/lang/String;Landroid/content/pm/PackageParser$Package;Z)Z
    ...
    const-string v16, "ApplicationPolicy"

    const-string v17, "isApplicationInstallationEnabled"
    ...
    const-string v19, "isApplicationInstallationEnabled() :  userID :   "
    ...
    const-string v18, "Could not retrieve permissions & signature for package"
    ...
    :try_start_3
    invoke-static/range {v16 .. v16}, Lcom/android/server/enterprise/RestrictionToastManager;->show(I)V
    ...
    const-string v18, "isApplicationInstallationEnabled :  enabled "
    ...
    invoke-static/range {v18 .. v19}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getContainerIdFromLUID(J)I
    ...
    invoke-direct {v0, v14, v1, v2}, Lcom/android/server/enterprise/application/ApplicationPolicy;->checkPkgNameMatch(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v19, "isApplicationInstallationEnabled :  Checking PKG WL - "
    ...
    const-string v19, "isApplicationInstallationEnabled :  Checking PKG BL - "
    ...
    const-string v19, "isApplicationInstallationEnabled :  enabled "
    ...
    iget-object v0, v5, Lcom/android/server/enterprise/application/ApplicationPolicy$ApplicationPackageInfo;->permissions:Ljava/util/List;
    ...
    const-string v18, "PermissionInstallationBlacklist"
    ...
    invoke-interface {v4, v0}, Ljava/util/List;->retainAll(Ljava/util/Collection;)Z
    ...
    const-string v19, "isApplicationInstallationEnabled :  Checking PERM BL - "
    ...
    iget-object v0, v5, Lcom/android/server/enterprise/application/ApplicationPolicy$ApplicationPackageInfo;->signatures:Ljava/util/List;
    ...
    const-string v18, "SignatureInstallationWhitelist"
    ...
    const-string v18, "SignatureInstallationBlacklist"
    ...
    invoke-interface {v6, v0}, Ljava/util/List;->retainAll(Ljava/util/Collection;)Z
    ...
    const-string v19, "isApplicationInstallationEnabled :  Checking SIG BL - "
    ...
    invoke-virtual {v8, v0}, Lcom/android/server/enterprise/EnterpriseDeviceManagerService;->getActiveAdminsInfo(I)Ljava/util/List;
    ...
    check-cast v10, Landroid/app/enterprise/EnterpriseDeviceAdminInfo;

    invoke-virtual {v10}, Landroid/app/enterprise/EnterpriseDeviceAdminInfo;->getPackageName()Ljava/lang/String;
    ...
    invoke-virtual {v10}, Landroid/app/enterprise/EnterpriseDeviceAdminInfo;->isProxy()Z
    ...
    invoke-virtual {v8, v0}, Lcom/android/server/enterprise/EnterpriseDeviceManagerService;->isUMCAdmin(Ljava/lang/String;)Z
    :try_end_a
    ...
    invoke-static/range {v18 .. v18}, Lcom/android/server/enterprise/RestrictionToastManager;->show(I)V
...
.method public addUsbDevicesForDefaultAccess(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;Ljava/util/List;)Z
    ...
    const-string v8, "addUsbDevicesforDefaultAccess for package: "
    ...
    const-string v7, "addUsbDevicesforDefaultAccess: Storeddevices exist already. So store only the ones which are mutually exclusive among both lists"
    ...
    const-string v7, "addUsbDevicesforDefaultAccess: Storeddevices doesnt exist"
