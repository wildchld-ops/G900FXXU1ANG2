...
.method public declared-synchronized edmUpdateConfiguredNetworks()V
    ...
    invoke-virtual {v11}, Landroid/app/enterprise/EnterpriseDeviceManager;->hasAnyActiveAdmin()Z
    ...
    invoke-static {v11}, Lcom/android/server/enterprise/wifi/WifiPolicy;->removeDoubleQuotes(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v11, v12}, Landroid/net/wifi/WifiEnterpriseConfig;->setCaCertificateAlias(Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v12}, Landroid/net/wifi/WifiEnterpriseConfig;->setClientCertificateAlias(Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v1}, Lcom/android/server/enterprise/adapterlayer/WifiManagerAdapter;->save(Landroid/net/wifi/WifiConfiguration;)Z

    :cond_a
    iget-object v11, p0, Lcom/android/server/enterprise/wifi/WifiPolicy;->mWifiAdapter:Lcom/android/server/enterprise/adapterlayer/WifiManagerAdapter;

    invoke-virtual {v11, v1}, Lcom/android/server/enterprise/adapterlayer/WifiManagerAdapter;->forget(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    invoke-virtual {v11, v1, v12}, Landroid/sec/enterprise/WifiPolicyCache;->isNetworkAllowed(Landroid/net/wifi/WifiConfiguration;Z)Z

    move-result v11

    if-nez v11, :cond_c

    iget v11, v1, Landroid/net/wifi/WifiConfiguration;->status:I
    ...
    invoke-direct {p0, v11, v12}, Lcom/android/server/enterprise/wifi/WifiPolicy;->asyncEnableNetwork(IZ)V
    ...
    invoke-direct {p0, v11}, Lcom/android/server/enterprise/wifi/WifiPolicy;->updateNetworkLastSSID(Ljava/lang/String;)Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public setWifiProfile(Landroid/app/enterprise/ContextInfo;Landroid/app/enterprise/WifiAdminProfile;)Z
    ...
    const-string v13, "security level no longer supported"
    ...
    const-string v13, "security level not supported"
