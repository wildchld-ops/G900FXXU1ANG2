...
.field public static final MSG_WIFI_CHECK:I = 0xf

.field public static final MSG_WLUC:I = 0xe
...
.method onReceiveBroadcastIntent(Landroid/content/Intent;)V
    ...
    :cond_0
    sget-boolean v6, Lcom/android/server/ssrm/Feature;->SSRM_VZW_COOLDOWN_ENABLE:Z

    if-eqz v6, :cond_3

    iget-object v6, p0, Lcom/android/server/ssrm/Monitor;->mCoolDownMode:Lcom/android/server/ssrm/CoolDownMode;

    if-eqz v6, :cond_3

    iget-object v6, p0, Lcom/android/server/ssrm/Monitor;->mCoolDownMode:Lcom/android/server/ssrm/CoolDownMode;

    invoke-virtual {v6, v1, p1}, Lcom/android/server/ssrm/CoolDownMode;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_3
    sget-boolean v6, Lcom/android/server/ssrm/Feature;->SSRM_BATTERY_COOLDOWN_ENABLE:Z

    if-eqz v6, :cond_1

    iget-object v6, p0, Lcom/android/server/ssrm/Monitor;->mBatteryCoolDownMode:Lcom/android/server/ssrm/BatteryCoolDownMode;

    if-eqz v6, :cond_1

    iget-object v6, p0, Lcom/android/server/ssrm/Monitor;->mBatteryCoolDownMode:Lcom/android/server/ssrm/BatteryCoolDownMode;

    invoke-virtual {v6, v1, p1}, Lcom/android/server/ssrm/BatteryCoolDownMode;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v6, "sec_container_1.com.sec.android.intent.action.SSRM_REQUEST"
    ...
    const-string v6, "sec_container_1.com.sec.android.intent.action.DVFS_POLARIS_PDF_VIEW"
    ...
    sget-boolean v6, Lcom/android/server/ssrm/Feature;->MODEL_K:Z
    ...
    const-string v8, "Intent.EXTRA_USER_HANDLE:: "
...
.method public registerIntentFilters()V
    ...
    const-string v29, "com.sec.factory.permission.KEYSTRING"
