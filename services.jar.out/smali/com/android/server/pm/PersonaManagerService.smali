...
.field private static final FOTA_UPGRADE_VERSION:I = 0x1

.field private static final INSTALLATION_WAIT_TIME:J = 0x2bf20L

.field private static final INTENT_ACTION_KNOX_BRIDGE_SYNCING:Ljava/lang/String; = "com.sec.knox.dar.fotaupgrade.done"

.field private static final INTENT_ACTION_KNOX_PARTITION_UPGRADE_COMPLETED:Ljava/lang/String; = "com.sec.knox.container.INTENT_PARTITION_UPGRADE_COMPLETED"
...
.field private static final MSG_KNOX_BRIDGE_SYNCING_DONE:I = 0x17
...
.field private static final MSG_UPGRADE_PARTITION_DONE:I = 0x16
...
.field private static final SDP_DEBUG:Z
...
.field private static mSdpService:Lcom/android/dar/SdpManager;
...
.field private mLastIntentSentWhileSwitching:Landroid/content/Intent;
...
.field private mPartitionUpgrading:Z
...
.method static constructor <clinit>()V
    ...
    sput-object v5, Lcom/android/server/pm/PersonaManagerService;->mSdpService:Lcom/android/dar/SdpManager;

    sput-object v5, Lcom/android/server/pm/PersonaManagerService;->sContext:Landroid/content/Context;
    ...
    sput-boolean v0, Lcom/android/server/pm/PersonaManagerService;->SDP_DEBUG:Z
...
.method private constructor <init>(Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Ljava/lang/Object;Ljava/lang/Object;Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object v3, p0, Lcom/android/server/pm/PersonaManagerService;->mLastShortcutModes:Landroid/util/SparseBooleanArray;

    new-instance v3, Landroid/util/SparseBooleanArray;

    invoke-direct {v3}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v3, p0, Lcom/android/server/pm/PersonaManagerService;->mBackPressed:Landroid/util/SparseBooleanArray;

    new-instance v3, Landroid/util/SparseBooleanArray;

    invoke-direct {v3}, Landroid/util/SparseBooleanArray;-><init>()V

    iput-object v3, p0, Lcom/android/server/pm/PersonaManagerService;->mKeyguardShown:Landroid/util/SparseBooleanArray;
    ...
    iput-object v3, p0, Lcom/android/server/pm/PersonaManagerService;->mToken:Landroid/os/IBinder;

    iput-boolean v5, p0, Lcom/android/server/pm/PersonaManagerService;->mPartitionUpgrading:Z

    iput-object v4, p0, Lcom/android/server/pm/PersonaManagerService;->mLastIntentSentWhileSwitching:Landroid/content/Intent;
    ...
    iput-object v3, p0, Lcom/android/server/pm/PersonaManagerService;->mSdpTimerMap:Ljava/util/HashMap;

    iput-object v4, p0, Lcom/android/server/pm/PersonaManagerService;->mService:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    iput-object v3, p0, Lcom/android/server/pm/PersonaManagerService;->mSdpLock:Ljava/lang/Object;
...
.method static synthetic access$1000(Lcom/android/server/pm/PersonaManagerService;)Lcom/android/server/pm/PackageManagerService;
    .locals 1
...
.method static synthetic access$1100(Lcom/android/server/pm/PersonaManagerService;)Ljava/util/HashMap;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$1200(Lcom/android/server/pm/PersonaManagerService;IZ)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
    .param p2    # Z
...
.method static synthetic access$1300(Lcom/android/server/pm/PersonaManagerService;I)Z
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
...
.method static synthetic access$1500(Lcom/android/server/pm/PersonaManagerService;IZ)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
    .param p2    # Z
...
.method static synthetic access$1700(Lcom/android/server/pm/PersonaManagerService;I)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
...
.method static synthetic access$1800(Lcom/android/server/pm/PersonaManagerService;)Landroid/os/RemoteCallbackList;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$2000(Lcom/android/server/pm/PersonaManagerService;I)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
...
.method static synthetic access$2100(Lcom/android/server/pm/PersonaManagerService;)Ljava/util/ArrayList;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$2102(Lcom/android/server/pm/PersonaManagerService;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$2200(Lcom/android/server/pm/PersonaManagerService;IZ)I
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
    .param p2    # Z
...
.method static synthetic access$2400(Lcom/android/server/pm/PersonaManagerService;)Ljava/lang/String;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$2600(Lcom/android/server/pm/PersonaManagerService;ILjava/lang/String;)I
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
...
.method static synthetic access$2800(Lcom/android/server/pm/PersonaManagerService;Landroid/content/pm/PersonaInfo;)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # Landroid/content/pm/PersonaInfo;
...
.method static synthetic access$3000(Lcom/android/server/pm/PersonaManagerService;Landroid/content/pm/PersonaInfo;)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # Landroid/content/pm/PersonaInfo;
...
.method static synthetic access$3100(Lcom/android/server/pm/PersonaManagerService;)Landroid/util/SparseArray;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$3200(Lcom/android/server/pm/PersonaManagerService;I)Z
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
...
.method static synthetic access$3300(Lcom/android/server/pm/PersonaManagerService;Ljava/lang/String;II)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$3400(Lcom/android/server/pm/PersonaManagerService;II)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
    .param p2    # I
...
.method static synthetic access$3700(Lcom/android/server/pm/PersonaManagerService;IZ)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
    .param p2    # Z

    invoke-direct {p0, p1, p2}, Lcom/android/server/pm/PersonaManagerService;->killSdpTimer(IZ)V

    return-void
.end method

.method static synthetic access$3800(Lcom/android/server/pm/PersonaManagerService;)Landroid/content/Intent;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;

    iget-object v0, p0, Lcom/android/server/pm/PersonaManagerService;->mLastIntentSentWhileSwitching:Landroid/content/Intent;

    return-object v0
.end method

.method static synthetic access$3802(Lcom/android/server/pm/PersonaManagerService;Landroid/content/Intent;)Landroid/content/Intent;
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # Landroid/content/Intent;

    iput-object p1, p0, Lcom/android/server/pm/PersonaManagerService;->mLastIntentSentWhileSwitching:Landroid/content/Intent;
...
.method static synthetic access$3900()Z
    ...
    sget-boolean v0, Lcom/android/server/pm/PersonaManagerService;->SDP_DEBUG:Z
...
.method static synthetic access$4000(Lcom/android/server/pm/PersonaManagerService;IZZ)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
    .param p2    # Z
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/pm/PersonaManagerService;->setSdpActiveAndPartitionUpgrading(IZZ)V

    return-void
.end method

.method static synthetic access$4100(Lcom/android/server/pm/PersonaManagerService;)Lcom/android/server/pm/HandlerCacheManager;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$4200(Lcom/android/server/pm/PersonaManagerService;)Ljava/lang/Object;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$4300(Lcom/android/server/pm/PersonaManagerService;)Ljava/lang/Object;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$4400(Lcom/android/server/pm/PersonaManagerService;I)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
...
.method static synthetic access$4500(Lcom/android/server/pm/PersonaManagerService;)Landroid/util/SparseBooleanArray;
    .locals 1
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
...
.method static synthetic access$4600(Lcom/android/server/pm/PersonaManagerService;I)V
    .locals 0
    .param p0    # Lcom/android/server/pm/PersonaManagerService;
    .param p1    # I
...
.method private addSdpWhiteAppsList(Landroid/content/pm/PersonaInfo;)V
    .locals 6
    .param p1    # Landroid/content/pm/PersonaInfo;
    ...
    new-instance v1, Landroid/content/pm/SdpProcessInfo;

    const-string v2, "com.sec.sdp"

    invoke-direct {v1, v2, v5, v3, v3}, Landroid/content/pm/SdpProcessInfo;-><init>(Ljava/lang/String;IZZ)V
    ...
    invoke-direct {v1, v2, v5, v4, v3}, Landroid/content/pm/SdpProcessInfo;-><init>(Ljava/lang/String;IZZ)V
    ...
    const-string v2, "com.sec.android.provider.badge"

    invoke-direct {v1, v2, v5, v4, v4}, Landroid/content/pm/SdpProcessInfo;-><init>(Ljava/lang/String;IZZ)V
    ...
    invoke-direct {v1, v2, v3, v3, v3}, Landroid/content/pm/SdpProcessInfo;-><init>(Ljava/lang/String;IZZ)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Landroid/content/pm/SdpProcessInfo;

    const-string v2, "com.sec.enterprise.email"
    ...
    invoke-direct {v1, v2, v3, v3, v4}, Landroid/content/pm/SdpProcessInfo;-><init>(Ljava/lang/String;IZZ)V
    ...
    const-string v2, "com.sec.knox.securehandler"
    ...
    const-string v2, "com.visionobjects.resourcemanager"
    ...
    invoke-direct {v1, v2, v3, v4, v3}, Landroid/content/pm/SdpProcessInfo;-><init>(Ljava/lang/String;IZZ)V
    ...
    invoke-direct {v1, v2, v3, v4, v4}, Landroid/content/pm/SdpProcessInfo;-><init>(Ljava/lang/String;IZZ)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Landroid/content/pm/SdpProcessInfo;

    const-string v2, "com.sec.konx.sdpemailtest"
    ...
    const-string v2, "com.f5.edge.client_ics"
    ...
    const-string v2, "net.juniper.junos.pulse.android"
    ...
    const-string v2, "net.juniper.junos.pulse_samsung_newsig.android"
    ...
    const-string v2, "com.sec.enterprise.knox.cisco.anyconnect.vpn.service"
    ...
    const-string v2, "de.blinkt.openvpn"
    ...
    invoke-virtual {p1, v0}, Landroid/content/pm/PersonaInfo;->setSdpWhiteList(Ljava/util/List;)V
...
.method private changeStateAndSwitch(I)V
    ...
    const-string v7, "postEvent() IPersonaStateHandler from HandlerCacheManager is null."
...
.method private cleanProviders(I)V
    ...
    iget-boolean v10, v3, Landroid/content/pm/PersonaInfo;->isKioskModeEnabled:Z
    ...
    const-string v12, "Reset persona clipboard : removing files for pkgDir "
    ...
    invoke-direct {p0, v0, p1, v4}, Lcom/android/server/pm/PersonaManagerService;->removeFilesForSysApp(Lcom/sec/knox/container/util/EnterprisePartitionManager;ILjava/io/File;)V

    new-instance v1, Landroid/content/Intent;

    const-string v10, "com.samsung.knox.clipboard.sync"
    ...
    iget-object v10, p0, Lcom/android/server/pm/PersonaManagerService;->mBaseUserPath:Ljava/io/File;
    ...
    invoke-direct {p0, v0, v13, v5}, Lcom/android/server/pm/PersonaManagerService;->removeFilesForSysApp(Lcom/sec/knox/container/util/EnterprisePartitionManager;ILjava/io/File;)V
    ...
    const-string v12, "Reset Setting provider removing files for pkgDir "
    ...
    invoke-virtual {v0, v10, p1}, Lcom/sec/knox/container/util/EnterprisePartitionManager;->deleteFile(Ljava/lang/String;I)Z
    ...
    const-string v12, "Reset Setting app removing files "
    ...
    const-string v11, "/settings.db-shm"
    ...
    const-string v11, "/settings.db-wal"
    ...
    const-string v12, " resetPersonaClipboard data file doesn\'t exist for persona "
    ...
    const-string v11, " Reset Setting provider : file doesn\'t exist on owner"
...
.method private initMdppKeystore(I)Z
    ...
    const-string v5, "initMdppKeystore personaId "
    ...
    const-string v4, "initMdppKeystore : current password cannot be null"
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/internal/widget/LockPatternUtils;->checkPassword(ILjava/lang/String;)Z
    ...
    const-string v4, "initMdppKeystore : checkPassword is not successful"
...
.method private isLockState(I)Z
    .locals 1
    .param p1    # I

    invoke-direct {p0, p1}, Lcom/android/server/pm/PersonaManagerService;->isSuperLockState(I)Z
...
.method private isPwdChangedEnforced(I)Z
    .locals 4
    .param p1    # I
    ...
    const-string v3, "isPwdChangedEnforced: returns true"
...
.method private killSdpTimer(IZ)V
    .locals 9
    .param p1    # I
    .param p2    # Z
    ...
    const-string v7, "killSdptimer remoing all msg: "
    ...
    const-string v5, "com.sec.knox.container.INTENT_KNOX_SDP_ACTIVATED"
    ...
    iget-object v5, p0, Lcom/android/server/pm/PersonaManagerService;->mSdpTimerMap:Ljava/util/HashMap;
...
.method private migrateOldPassword(I)V
    ...
    invoke-virtual {v3, v4, v5, v7, p1}, Lcom/android/internal/widget/LockPatternUtils;->saveLockPassword(Ljava/lang/String;IZI)V
...
.method private readUser(II)Landroid/content/pm/PersonaInfo;
    ...
    :try_start_0
    new-instance v61, Landroid/util/AtomicFile;
    ...
    sget-object v63, Ljava/io/File;->separator:Ljava/lang/String;
    ...
    invoke-virtual/range {v61 .. v61}, Landroid/util/AtomicFile;->openRead()Ljava/io/FileInputStream;
    ...
    const-string v63, "Unable to read user "
    ...
    const-string v9, "PartitionUpgrading"
    ...
    const-string v5, "BridgeSyncing"

    move-object/from16 v0, p0

    move-object/from16 v1, v40

    invoke-direct {v0, v1, v5, v13}, Lcom/android/server/pm/PersonaManagerService;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
    ...
    invoke-interface/range {v40 .. v40}, Lorg/xmlpull/v1/XmlPullParser;->getText()Ljava/lang/String;
    ...
    iput-wide v14, v4, Landroid/content/pm/PersonaInfo;->creationTime:J
    ...
    invoke-virtual {v4, v0}, Landroid/content/pm/PersonaInfo;->setPartitionUpgrading(Z)V

    invoke-virtual {v4, v13}, Landroid/content/pm/PersonaInfo;->setBridgeSyncing(I)V
    ...
    const-string v63, "readUser: Installed pkg list: "
    ...
    invoke-direct {v0, v4}, Lcom/android/server/pm/PersonaManagerService;->addSdpWhiteAppsList(Landroid/content/pm/PersonaInfo;)V
    :try_end_4
...
.method private scheduleSdpTimer(IZ)V
    ...
    iget-object v12, p0, Lcom/android/server/pm/PersonaManagerService;->mSdpTimerMap:Ljava/util/HashMap;

    monitor-enter v12

    :try_start_0
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/pm/PersonaManagerService;->getPersonaState(I)I
    ...
    const-string v14, "scheduleSdpTimer called: "
    ...
    invoke-direct {p0, v6}, Lcom/android/server/pm/PersonaManagerService;->isLockState(I)Z
    ...
    const-string v11, "com.sec.knox.container.INTENT_KNOX_SDP_ACTIVATED"
    ...
    add-int/lit16 v13, v0, 0x2643

    const/high16 v14, 0x48000000

    invoke-static {v11, v13, v2, v14}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v5

    invoke-virtual {v1, v5}, Landroid/app/AlarmManager;->cancel(Landroid/app/PendingIntent;)V

    iget-object v11, p0, Lcom/android/server/pm/PersonaManagerService;->mSdpTimerMap:Ljava/util/HashMap;
    ...
    invoke-direct/range {p0 .. p1}, Lcom/android/server/pm/PersonaManagerService;->getSdpActivateTime(I)J
    ...
    const-string v14, "scheduleSdpTimer(): force restart: "
    ...
    invoke-virtual {v1, v11, v13, v14, v5}, Landroid/app/AlarmManager;->set(IJLandroid/app/PendingIntent;)V
...
.method private sdpFotaUpgrade(Landroid/content/pm/PersonaInfo;)V
    .locals 8
    .param p1    # Landroid/content/pm/PersonaInfo;
    ...
    const-string v4, "dar test sdpFotaUpgrade id: "
    ...
    :cond_0
    invoke-virtual {p1}, Landroid/content/pm/PersonaInfo;->isPartitionUpgrading()Z
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/sec/knox/container/util/KnoxFileHandler;->sdpUserAdded(IZI)Z

    iget v0, p1, Landroid/content/pm/PersonaInfo;->id:I

    const-string v1, "com.sec.sdp"

    invoke-direct {p0, v0, v1}, Lcom/android/server/pm/PersonaManagerService;->installExistingPackageForPersona(ILjava/lang/String;)I
    ...
    const-string v1, "dar test already installed dar package."
    ...
    const-string v1, "sec_container_1.com.android.contacts"
    ...
    const-string v1, "dar testinstalled dar package."
    ...
    iput-boolean v2, p0, Lcom/android/server/pm/PersonaManagerService;->mPartitionUpgrading:Z
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/sec/knox/container/util/KnoxFileHandler;->startPartitionUpgrade(IZIII)Z
    ...
    const-string v1, "PartitionUpgrading succs, "
    ...
    const-string v1, "dar test sdpFotaUpgrade PartitionUpgrading is finished already "
...
.method private setSdpActive(IZ)V
    ...
    invoke-virtual {v0, p2}, Landroid/content/pm/PersonaInfo;->setSdpActive(Z)V
...
.method private setSdpActiveAndPartitionUpgrading(IZZ)V
    .locals 2
    .param p1    # I
    .param p2    # Z
    .param p3    # Z
    ...
    invoke-virtual {v0, p3}, Landroid/content/pm/PersonaInfo;->setPartitionUpgrading(Z)V
...
.method private softStartPersona([I)Z
    .locals 9
    .param p1    # [I
    ...
    invoke-virtual {v5}, Landroid/content/pm/PersonaInfo;->isBridgeSyncing()I
    ...
    invoke-virtual {v0, v4}, Landroid/app/ActivityManager;->softStartPersonas([I)Z
...
.method private writeUserLocked(Landroid/content/pm/PersonaInfo;)V
    ...
    const-string v10, "PartitionUpgrading"
    ...
    const-string v10, "BridgeSyncing"

    invoke-virtual {p1}, Landroid/content/pm/PersonaInfo;->isBridgeSyncing()I
...
.method public activateSdp(I)Z
    ...
    const-string v9, "SDP :: activateSdp personaId="
    ...
    const-string v8, "activateSdp : can\'t get persona-info : "
    ...
    :cond_0
    invoke-virtual {v3}, Landroid/content/pm/PersonaInfo;->isBridgeSyncing()I
    ...
    const-string v6, "SDP compromized. unmounting.."
    ...
    invoke-virtual {v5, p1}, Lcom/sec/knox/container/util/KnoxFileHandler;->unmount(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v6, "FATAL >>>> unmount failed."
    ...
    invoke-virtual {v5, p1}, Lcom/sec/knox/container/util/KnoxFileHandler;->sdpLocked(I)Z
    ...
    const-string v8, "SDP :: unmounting sdcard"
    ...
    invoke-virtual {v7, p1, v8}, Lcom/sec/knox/container/util/KnoxFileHandler;->unmount(II)Z
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-virtual {v7, p1}, Lcom/sec/knox/container/util/KnoxFileHandler;->sdpLocked(I)Z
    ...
    const-string v8, "FATAL >>>> SDP unmounting sdcard failed. persona - "
    ...
    const-string v9, "Failed to unmount file system. "
    ...
    const-string v7, "SDP :: softStartPersonas()"
    ...
    invoke-virtual {v0, v2}, Landroid/app/ActivityManager;->softStartPersonas([I)Z

    iget-object v5, p0, Lcom/android/server/pm/PersonaManagerService;->mContext:Landroid/content/Context;

    new-instance v7, Landroid/content/Intent;

    const-string v8, "com.sec.knox.dar.launch_white_apps"
...
.method public calmSdp(I)Z
    ...
    const-string v6, "inside calmSdp state "
    ...
    invoke-virtual {v1}, Landroid/content/pm/PersonaInfo;->isSdpActive()Z
    ...
    const-string v6, "calmSdp failed :: persona :"
    ...
    const-string v6, " is not SDP active"
...
.method public changeEcryptFsKey(ILjava/lang/String;)Z
    .locals 8
    .param p1    # I
    .param p2    # Ljava/lang/String;
    ...
    const-string v7, "PMS.changeEcryptFsKey->  personaId :"
    ...
    invoke-virtual {v5, p1, v6, p2, v7}, Lcom/sec/knox/container/util/KnoxFileHandler;->changeEncryptionKey(ILjava/lang/String;Ljava/lang/String;Z)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v7, "PMS.changeEcryptFsKey->  not valid personaid - "
...
.method public createPersona(Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;Landroid/net/Uri;Landroid/net/Uri;)I
    ...
    invoke-virtual {v4, v6}, Landroid/content/pm/PersonaInfo;->setPartitionUpgrading(Z)V

    const/4 v6, 0x2

    invoke-virtual {v4, v6}, Landroid/content/pm/PersonaInfo;->setBridgeSyncing(I)V
    ...
    :try_end_27
    .catch Landroid/os/RemoteException; {:try_start_27 .. :try_end_27} :catch_1
    ...
    invoke-virtual {v6, v5, v7}, Lcom/sec/knox/container/util/KnoxFileHandler;->sdpUnlocked(II)Z
    :try_end_28
    ...
    const-string v7, "Unable to sdpUnlocked"
...
.method public getEncodedPassword(Ljava/lang/String;IZ)Ljava/lang/String;
    ...
    iget v6, v2, Landroid/content/pm/PersonaInfo;->fotaUpgradeVersion:I
    ...
    invoke-direct {p0, p2}, Lcom/android/server/pm/PersonaManagerService;->isPwdChangedEnforced(I)Z
    ...
    const-string v7, "Skipping due to force reset state OR during migration : "
    ...
    invoke-direct {p0, v4, v5}, Lcom/android/server/pm/PersonaManagerService;->writeFile(Ljava/lang/String;[B)V

    :cond_4
    invoke-direct {p0, v4}, Lcom/android/server/pm/PersonaManagerService;->readFile(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v5, p2}, Lcom/android/internal/widget/LockPatternUtils;->passwordToHash(Ljava/lang/String;I)[B
...
.method public getPasswordHint()Ljava/lang/String;
    ...
    const-string v1, "getPasswordHint"
...
.method public handleHomeShow()Z
    ...
    const-string v3, "handleHomeShow"
    ...
    iget-object v3, p0, Lcom/android/server/pm/PersonaManagerService;->mShortcutModes:Landroid/util/SparseBooleanArray;
    ...
    const-string/jumbo v3, "switchPersonaAndLaunchPersonalHome"

    invoke-direct {v1, v3}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    invoke-virtual {p0, v2, v1}, Lcom/android/server/pm/PersonaManagerService;->switchPersonaAndLaunch(ILandroid/content/Intent;)Z
...
.method public notifyKeyguardShow(IZ)V
    ...
    const-string v7, "notify keyguard show for "
    ...
    const-string v6, "container_keyguard"

    invoke-interface {v4, p1, v1, v5, v6}, Lcom/android/internal/statusbar/IStatusBarService;->disableAsUser(IILandroid/os/IBinder;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v5, p0, Lcom/android/server/pm/PersonaManagerService;->mKeyguardShown:Landroid/util/SparseBooleanArray;

    invoke-virtual {v5, p1, p2}, Landroid/util/SparseBooleanArray;->put(IZ)V

    new-instance v0, Landroid/content/Intent;

    const-string v5, "com.sec.knox.keyguard.show"
...
.method public removePersona(I)I
    ...
    :cond_2
    :try_start_5
    iget-object v7, p0, Lcom/android/server/pm/PersonaManagerService;->mRemovingPersonaIds:Landroid/util/SparseBooleanArray;

    const/4 v10, 0x1

    invoke-virtual {v7, p1, v10}, Landroid/util/SparseBooleanArray;->put(IZ)V
    ...
    iput-boolean v7, v5, Landroid/content/pm/PersonaInfo;->removePersona:Z
    ...
    invoke-virtual {v7, v10}, Lcom/android/server/pm/PersonaManagerService$PersonaHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v7, v4, v10, v11}, Lcom/android/server/pm/PersonaManagerService$PersonaHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    const-string v8, " Calling handler : MSG_START_REMOVE_PERSONA_AFTER_SWITCH"
    ...
    invoke-virtual {v7, v4}, Lcom/android/server/pm/PersonaManagerService$PersonaHandler;->sendMessage(Landroid/os/Message;)Z

    iget-object v7, p0, Lcom/android/server/pm/PersonaManagerService;->mFSHandler:Lcom/sec/knox/container/util/KnoxFileHandler;

    invoke-virtual {v7, p1}, Lcom/sec/knox/container/util/KnoxFileHandler;->sdpUserRemoved(I)Z
...
.method public resetPersonaDataPartition(I)Z
    ...
    const-string v1, "resetPersonaDataPartition"
...
.method public savePasswordInTima(ILjava/lang/String;)Z
    ...
    iget v9, v1, Landroid/content/pm/PersonaInfo;->state:I

    const/4 v10, 0x5

    if-ne v9, v10, :cond_2

    invoke-direct {p0, p1}, Lcom/android/server/pm/PersonaManagerService;->isPwdChangedEnforced(I)Z
...
.method public setBridgeSyncing(II)V
    ...
    invoke-virtual {v0, p2}, Landroid/content/pm/PersonaInfo;->setBridgeSyncing(I)V
...
.method public switchPersona(I)Z
    ...
    const-string v10, "sdpp switching to persona "
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/ActivityManagerService;->getStartedUserState(I)Lcom/android/server/am/UserStartedState;
    ...
    const-string/jumbo v9, "switchPersona uss null"
    ...
    iget v8, v6, Lcom/android/server/am/UserStartedState;->mState:I
    ...
    const-string v10, "sdpp switching to persona returning "
    ...
    const-string/jumbo v10, "switchPersona uss.mState "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v10, v6, Lcom/android/server/am/UserStartedState;->mState:I
    ...
    iput-object v8, p0, Lcom/android/server/pm/PersonaManagerService;->mLastIntentSentWhileSwitching:Landroid/content/Intent;
    ...
    const-string v9, "Switch not allowed because removePersona flag is true"
    ...
    const-string v10, "Exception while switching to persona "
...
.method public switchPersonaAndLaunch(ILandroid/content/Intent;)Z
    ...
    const-string/jumbo v9, "switchPersonaAndLaunch uss null"
    ...
    const-string/jumbo v10, "switchPersonaAndLaunch uss.mState "
    ...
    :cond_2
    iput-object p2, p0, Lcom/android/server/pm/PersonaManagerService;->mLastIntentSentWhileSwitching:Landroid/content/Intent;
    ...
    const-string v9, "Switch not allowed because either partial flag or remove flag is true"
