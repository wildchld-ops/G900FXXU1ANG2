...
.method public handleStartCopy()V
    ...
    iget v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->flags:I
    ...
    iget-object v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->mPackageURI:Landroid/net/Uri;

    if-nez v8, :cond_2

    const-string v8, "PackageManager"

    const-string v9, "NPE encountered in handle start copy:"
    ...
    iget-object v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->this$0:Lcom/android/server/pm/PackageManagerService;

    # getter for: Lcom/android/server/pm/PackageManagerService;->mContainerService:Lcom/android/internal/app/IMediaContainerService;
    invoke-static {v8}, Lcom/android/server/pm/PackageManagerService;->access$300(Lcom/android/server/pm/PackageManagerService;)Lcom/android/internal/app/IMediaContainerService;
    ...
    iget v10, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->flags:I

    const-wide/16 v11, 0x0

    invoke-interface {v8, v9, v10, v11, v12}, Lcom/android/internal/app/IMediaContainerService;->getMinimalPackageInfo(Ljava/lang/String;IJ)Landroid/content/pm/PackageInfoLite;
    ...
    invoke-static {v8, v9}, Lcom/android/server/pm/PackageManagerService;->access$3000(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;)Z
    ...
    iget-object v9, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-static {v9, v0, v10, v8, v11}, Lcom/android/server/pm/PackageManagerService;->access$3100(Lcom/android/server/pm/PackageManagerService;Ljava/io/File;Ljava/lang/String;ZI)Z
    ...
    # invokes: Lcom/android/server/pm/PackageManagerService;->createInstallArgs(Lcom/android/server/pm/PackageManagerService$InstallParams;)Lcom/android/server/pm/PackageManagerService$InstallArgs;
    invoke-static {v8, v0}, Lcom/android/server/pm/PackageManagerService;->access$3300(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageManagerService$InstallParams;)Lcom/android/server/pm/PackageManagerService$InstallArgs;
    ...
    invoke-static {v8, v0}, Lcom/android/server/pm/PackageManagerService;->access$3400(Lcom/android/server/pm/PackageManagerService;I)Ljava/util/ArrayList;
    ...
    sget-object v8, Lcom/android/server/pm/PackageManagerService;->sPersonaManager:Lcom/android/server/pm/PersonaManagerService;
    ...
    invoke-virtual {v8, v9, v10}, Lcom/android/server/pm/PersonaManagerService;->needVerificationForPackage(ILjava/lang/String;)Z
    ...
    const-string v10, "Skipping verification for Persona "
    ...
    iget v9, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->flags:I

    # invokes: Lcom/android/server/pm/PackageManagerService;->isVerificationEnabled(I)Z
    invoke-static {v8, v9}, Lcom/android/server/pm/PackageManagerService;->access$3500(Lcom/android/server/pm/PackageManagerService;I)Z
    ...
    invoke-virtual {v8, v5, v9, v10, v0}, Lcom/android/server/pm/PackageManagerService;->queryIntentReceivers(Landroid/content/Intent;Ljava/lang/String;II)Ljava/util/List;
    ...
    const-string v10, " verifiers for intent "
    ...
    iget-object v10, v0, Landroid/content/pm/PackageInfoLite;->verifiers:[Landroid/content/pm/VerifierInfo;
    ...
    const-string v10, " optional verifiers"
    ...
    invoke-static {v8}, Lcom/android/server/pm/PackageManagerService;->access$3608(Lcom/android/server/pm/PackageManagerService;)I
    ...
    const-string v8, "KNOXVerificationInstallerUid"

    move-object/from16 v0, p0

    iget v9, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->installerUid:I

    invoke-virtual {v5, v8, v9}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v8, "KNOXVerificationPackagePath"

    move-object/from16 v0, p0

    iget-object v9, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->mPackageURI:Landroid/net/Uri;
    ...
    iget-object v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->verificationParams:Landroid/content/pm/VerificationParams;
    ...
    invoke-virtual {v8}, Landroid/content/pm/VerificationParams;->getVerificationURI()Landroid/net/Uri;

    move-result-object v8

    if-eqz v8, :cond_6

    const-string v8, "android.content.pm.extra.VERIFICATION_URI"

    move-object/from16 v0, p0

    iget-object v9, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->verificationParams:Landroid/content/pm/VerificationParams;

    invoke-virtual {v9}, Landroid/content/pm/VerificationParams;->getVerificationURI()Landroid/net/Uri;
    ...
    invoke-virtual {v8}, Landroid/content/pm/VerificationParams;->getOriginatingURI()Landroid/net/Uri;
    ...
    invoke-virtual {v9}, Landroid/content/pm/VerificationParams;->getOriginatingURI()Landroid/net/Uri;
    ...
    invoke-virtual {v8}, Landroid/content/pm/VerificationParams;->getReferrer()Landroid/net/Uri;
    ...
    invoke-virtual {v9}, Landroid/content/pm/VerificationParams;->getReferrer()Landroid/net/Uri;
    ...
    invoke-virtual {v8}, Landroid/content/pm/VerificationParams;->getOriginatingUid()I
    ...
    invoke-virtual {v9}, Landroid/content/pm/VerificationParams;->getOriginatingUid()I
    ...
    invoke-virtual {v8}, Landroid/content/pm/VerificationParams;->getInstallerUid()I

    move-result v8

    if-ltz v8, :cond_a

    const-string v8, "android.content.pm.extra.VERIFICATION_INSTALLER_UID"
    ...
    :cond_a
    new-instance v3, Lcom/android/server/pm/PackageVerificationState;

    move-object/from16 v0, p0

    iget-object v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->mTempPackage:Ljava/io/File;

    invoke-direct/range {v3 .. v8}, Lcom/android/server/pm/PackageVerificationState;-><init>(Ljava/util/ArrayList;Landroid/content/Intent;ILcom/android/server/pm/PackageManagerService$InstallArgs;Ljava/io/File;)V
    ...
    check-cast v41, Lcom/android/server/pm/PackageManagerService$VerifierPackage;
    ...
    invoke-static {v8, v9, v0}, Lcom/android/server/pm/PackageManagerService;->access$3700(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Ljava/util/List;)Landroid/content/ComponentName;

    move-result-object v8

    move-object/from16 v0, v41

    iput-object v8, v0, Lcom/android/server/pm/PackageManagerService$VerifierPackage;->componentName:Landroid/content/ComponentName;

    move-object/from16 v0, v41

    iget v8, v0, Lcom/android/server/pm/PackageManagerService$VerifierPackage;->uId:I

    invoke-virtual {v3, v8}, Lcom/android/server/pm/PackageVerificationState;->addRequiredVerifierUid(I)V
    ...
    const-string v9, "Conflicting flags specified for installing on both internal and external"
    ...
    check-cast v16, Lcom/android/server/DeviceStorageMonitorService;

    if-nez v16, :cond_11

    const-string v8, "PackageManager"

    const-string v9, "Couldn\'t get low memory threshold; no free limit imposed"
    ...
    iget-object v10, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->mPackageURI:Landroid/net/Uri;
    ...
    iget-object v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->encryptionParams:Landroid/content/pm/ContainerEncryptionParams;
    ...
    iget-object v9, v9, Lcom/android/server/pm/PackageManagerService;->mDrmAppPrivateInstallDir:Ljava/io/File;

    # invokes: Lcom/android/server/pm/PackageManagerService;->createTempPackageFile(Ljava/io/File;)Ljava/io/File;
    invoke-static {v8, v9}, Lcom/android/server/pm/PackageManagerService;->access$3200(Lcom/android/server/pm/PackageManagerService;Ljava/io/File;)Ljava/io/File;

    move-result-object v8

    move-object/from16 v0, p0

    iput-object v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->mTempPackage:Ljava/io/File;
    ...
    iget-object v10, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->encryptionParams:Landroid/content/pm/ContainerEncryptionParams;

    move-object/from16 v0, v25

    invoke-interface {v8, v9, v10, v0}, Lcom/android/internal/app/IMediaContainerService;->copyResource(Landroid/net/Uri;Landroid/content/pm/ContainerEncryptionParams;Landroid/os/ParcelFileDescriptor;)I
    ...
    invoke-interface {v8, v0, v9, v1, v2}, Lcom/android/internal/app/IMediaContainerService;->getMinimalPackageInfo(Ljava/lang/String;IJ)Landroid/content/pm/PackageInfoLite;

    move-result-object v29

    move-object/from16 v0, v29

    iget v8, v0, Landroid/content/pm/PackageInfoLite;->recommendedInstallLocation:I
    ...
    invoke-interface {v8, v0, v9}, Lcom/android/internal/app/IMediaContainerService;->calculateInstalledSize(Ljava/lang/String;Z)J
    ...
    invoke-virtual {v8, v9, v10}, Lcom/android/server/pm/Installer;->freeCache(J)I
    ...
    invoke-virtual {v8, v9, v10}, Landroid/content/Context;->revokeUriPermission(Landroid/net/Uri;I)V

    goto/16 :goto_4

    :cond_11
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/DeviceStorageMonitorService;->getMemoryLowThreshold()J
    ...
    invoke-virtual {v9, v10, v11}, Landroid/content/Context;->revokeUriPermission(Landroid/net/Uri;I)V
    ...
    invoke-direct {v0, v1, v8}, Lcom/android/server/pm/PackageManagerService$InstallParams;->installLocationPolicy(Landroid/content/pm/PackageInfoLite;I)I
    ...
    iput v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->flags:I
    ...
    invoke-virtual {v8, v5, v9, v10, v11}, Lcom/android/server/pm/PackageManagerService;->queryIntentReceivers(Landroid/content/Intent;Ljava/lang/String;II)Ljava/util/List;
    ...
    invoke-static {v8, v0, v1, v3}, Lcom/android/server/pm/PackageManagerService;->access$3800(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageInfoLite;Ljava/util/List;Lcom/android/server/pm/PackageVerificationState;)Ljava/util/List;
    ...
    invoke-static {v8, v3}, Lcom/android/server/pm/PackageManagerService;->access$3900(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageVerificationState;)Z

    const/4 v8, 0x0

    move-object/from16 v0, p0

    iput-object v8, v0, Lcom/android/server/pm/PackageManagerService$InstallParams;->mArgs:Lcom/android/server/pm/PackageManagerService$InstallArgs;
    ...
    const-string v42, "Install Application "
    ...
    invoke-static {v8}, Lcom/android/server/pm/PackageManagerService;->access$2500(Lcom/android/server/pm/PackageManagerService;)Landroid/content/IHarmonyEAS;
    ...
    invoke-interface {v8, v9, v10, v11}, Landroid/content/IHarmonyEAS;->setInstallationPackageUnknown(Ljava/lang/String;II)V
    :try_end_5
    ...
    invoke-virtual {v7, v8, v9}, Lcom/android/server/pm/PackageManagerService$InstallArgs;->copyApk(Lcom/android/internal/app/IMediaContainerService;Z)I
