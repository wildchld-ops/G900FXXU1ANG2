...
.method public constructor <init>(Ljava/lang/ref/WeakReference;)V
    ...
    invoke-virtual {p0, v2}, Lcom/samsung/contacts/util/ImsLowSignalBase;->setImsOn(Z)V

    invoke-virtual {p0, v2}, Lcom/samsung/contacts/util/ImsLowSignalBase;->setLowSignal(Z)V
...
.method public register()V
    ...
    invoke-virtual {p0}, Lcom/samsung/contacts/util/ImsLowSignalBase;->getActivity()Landroid/app/Activity;
    ...
    const-string v3, "mLowSignalObserver/register()"
    ...
    iget-object v3, p0, Lcom/samsung/contacts/util/ImsLowSignalWfc;->mRegistrationStateObserver:Landroid/database/ContentObserver;

    invoke-virtual {v0, v1, v2, v3}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    sget-object v1, Lcom/samsung/tmowfc/wfcutils/WfcDbHelper$LowSignalContract;->CONTENT_URI:Landroid/net/Uri;

    iget-object v3, p0, Lcom/samsung/contacts/util/ImsLowSignalWfc;->mLowSignalObserver:Landroid/database/ContentObserver;
    ...
    :goto_0
    invoke-virtual {p0, v1}, Lcom/samsung/contacts/util/ImsLowSignalBase;->setImsOn(Z)V
    ...
    invoke-virtual {p0, v1}, Lcom/samsung/contacts/util/ImsLowSignalBase;->setLowSignal(Z)V

    iput-boolean v2, p0, Lcom/samsung/contacts/util/ImsLowSignalWfc;->mIsRegistered:Z

    :cond_0
    invoke-virtual {p0}, Lcom/samsung/contacts/util/ImsLowSignalBase;->notifyLowSignalRegistraints()V
