...
.field private static mConfigAdditionalGroup:Ljava/lang/String;
...
.field private static mConfigSpamReport:Ljava/lang/String;
...
.field private static mDisableMergeWithGoogle:Z
...
.field private static mEnableNSNMatch:Z
...
.field private static mShowContactTip:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mDisableMergeWithGoogle:Z

    sput-boolean v1, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mShowContactTip:Z

    sput-boolean v1, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mEnableNSNMatch:Z

    const-string v0, ""

    sput-object v0, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mConfigSpamReport:Ljava/lang/String;

    const-string v0, ""

    sput-object v0, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mConfigAdditionalGroup:Ljava/lang/String;
...
.method private static setCscFeature()V
    ...
    const-string v1, "SwipeCall"

    invoke-static {}, Lcom/sec/android/app/CscFeature;->getInstance()Lcom/sec/android/app/CscFeature;

    move-result-object v2

    const-string v3, "CscFeature_Contact_ConfigHelpGuideForGesture"
    ...
    const-string v3, "CscFeature_Contact_ConfigTelNumMatchingForNationPrefix"
    ...
    const-string v2, "CscFeature_Message_ConfigSpamReport"

    invoke-virtual {v1, v2}, Lcom/sec/android/app/CscFeature;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    sput-object v1, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mConfigSpamReport:Ljava/lang/String;

    invoke-static {}, Lcom/sec/android/app/CscFeature;->getInstance()Lcom/sec/android/app/CscFeature;

    move-result-object v1

    const-string v2, "CscFeature_Contact_ConfigAdditionalGroup"

    invoke-virtual {v1, v2}, Lcom/sec/android/app/CscFeature;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    sput-object v1, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mConfigAdditionalGroup:Ljava/lang/String;
...
.method public getConfigAdditionalGroup()Ljava/lang/String;
    .locals 1

    sget-object v0, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mConfigAdditionalGroup:Ljava/lang/String;
...
.method public getConfigSpamReport()Ljava/lang/String;
    .locals 1

    sget-object v0, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mConfigSpamReport:Ljava/lang/String;
...
.method public getDisableMergeWithGoogle()Z
    .locals 1

    sget-boolean v0, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mDisableMergeWithGoogle:Z
...
.method public getEnableContactTip()Z
    .locals 1

    sget-boolean v0, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mShowContactTip:Z
...
.method public getEnableNSNMatch()Z
    .locals 1

    sget-boolean v0, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->mEnableNSNMatch:Z
...
.method public getEnableVoLTE()Z
    .locals 2
