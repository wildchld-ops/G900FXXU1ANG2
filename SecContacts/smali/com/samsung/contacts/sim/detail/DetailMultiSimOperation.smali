...
.method public createSelectSimDialog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, v1, v1}, Lcom/samsung/contacts/sim/PhoneBookManageSim;->isSimEnabled(IZ)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v6, v8, v1}, Lcom/samsung/contacts/sim/PhoneBookManageSim;->isSimEnabled(IZ)Z
...
.method public isSimDeactivate(Landroid/content/Context;Lcom/android/contacts/model/Contact;)Z
    ...
    invoke-virtual {v3, v5}, Lcom/samsung/contacts/sim/PhoneBookManageSim;->isSimEnabled(I)Z
    ...
    invoke-virtual {v3, v4}, Lcom/samsung/contacts/sim/PhoneBookManageSim;->isSimEnabled(I)Z
