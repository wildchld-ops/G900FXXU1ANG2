...
.field private mIceHelpTextView:Landroid/view/View;
...
.field private mMyEmergencyInfoView:Landroid/view/View;
...
.method private addSelectAllHeaderView()V
    .locals 2
    ...
    new-instance v1, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment$4;

    invoke-direct {v1, p0}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment$4;-><init>(Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;)V
...
.method private removeSelectAllHeader()V
    ...
    iput-object v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mSelectAllHeaderView:Landroid/view/View;
...
.method public loadGroup(Lcom/samsung/contacts/group/GroupInfo;)V
    ...
    const-string v5, "loadGroup : LOAD ICE GROUP"

    invoke-static {v2, v5}, Landroid/util/secutil/Log;->secI(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual {p0, v4}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->setQuickContactEnabled(Z)V

    const-string v2, "SprintICE"

    invoke-static {}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getInstance()Lcom/samsung/contacts/util/LoadCscFeatureUtils;

    move-result-object v5

    invoke-virtual {v5}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getConfigAdditionalGroup()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mMyEmergencyInfoView:Landroid/view/View;

    if-nez v2, :cond_0

    iget-object v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mContext:Landroid/content/Context;

    iget-object v5, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mContext:Landroid/content/Context;
    ...
    iput-object v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mMyEmergencyInfoView:Landroid/view/View;

    iget-object v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mMyEmergencyInfoView:Landroid/view/View;

    new-instance v5, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment$3;

    invoke-direct {v5, p0}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment$3;-><init>(Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;)V
    ...
    iget-object v5, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mMyEmergencyInfoView:Landroid/view/View;

    invoke-virtual {v2, v5, v6, v4}, Lcom/sec/android/touchwiz/widget/TwSweepActionListView;->addHeaderView(Landroid/view/View;Ljava/lang/Object;Z)V

    :cond_0
    iget-object v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mIceHelpTextView:Landroid/view/View;
    ...
    iput-object v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mIceHelpTextView:Landroid/view/View;

    invoke-virtual {p0}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->getListView()Lcom/sec/android/touchwiz/widget/TwSweepActionListView;

    move-result-object v2

    iget-object v5, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mIceHelpTextView:Landroid/view/View;

    invoke-virtual {v2, v5, v6, v4}, Lcom/sec/android/touchwiz/widget/TwSweepActionListView;->addFooterView(Landroid/view/View;Ljava/lang/Object;Z)V

    :cond_1
    iget-boolean v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mFromEmergencyDialer:Z
    ...
    :goto_0
    invoke-virtual {v0, v2}, Lcom/samsung/contacts/group/GroupMemberBrowseListAdapter;->setDisplayPhotos(Z)V
    ...
    :cond_3
    invoke-virtual {p0, v4}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->setVisibleTwIndexScrollbarEnabled(Z)V
    ...
    :goto_1
    invoke-direct {p0, v3}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->setAddMemberButtonVisibility(Z)V

    iget v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mGroupType:I

    invoke-virtual {v0, v2}, Lcom/samsung/contacts/group/GroupMemberBrowseListAdapter;->setMode(I)V
...
.method public onItemLongClick(Lcom/sec/android/touchwiz/widget/TwAdapterView;Landroid/view/View;IJ)Z
    ...
    iget-object v2, p0, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->mActionMode:Landroid/view/ActionMode;
    ...
    invoke-virtual {v1, v2, p4, p5}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment$ActionModeCallback;->onContactSelected(IJ)V
...
.method public onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    invoke-static {v0}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment$ActionModeCallback;->access$700(Lcom/samsung/contacts/group/GroupMemberBrowseListFragment$ActionModeCallback;)V
...
.method public setEmergencyContactsInfo(ZZ)V
    ...
    :goto_0
    invoke-direct {p0, v1}, Lcom/samsung/contacts/group/GroupMemberBrowseListFragment;->setSearchBarVisibility(Z)V
