...
.method private handleHomeKeyForVideoCall(Z)V
    ...
    invoke-direct {p0, v2, v1}, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->requestSystemKeyEvent(IZ)Z

    const/high16 v1, 0x10000

    or-int/2addr v0, v1

    iget-object v1, p0, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->mStatusBarManager:Landroid/app/StatusBarManager;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v4}, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/app/StatusBarManager;

    iput-object v4, p0, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->mStatusBarManager:Landroid/app/StatusBarManager;
    ...
    iput-boolean v4, p0, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->mMissingPhoneLock:Z
...
.method protected onStart()V
    ...
    iget-boolean v1, p0, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->mMissingPhoneLock:Z
    ...
    invoke-direct {p0, v1, v2}, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->requestSystemKeyEvent(IZ)Z
...
.method protected onStop()V
    ...
    iget-boolean v0, p0, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->mMissingPhoneLock:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->mStatusBarManager:Landroid/app/StatusBarManager;

    invoke-virtual {v0, v2}, Landroid/app/StatusBarManager;->disable(I)V

    const/16 v0, 0xbb

    invoke-direct {p0, v0, v2}, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->requestSystemKeyEvent(IZ)Z
...
.method public returnPickerResult(Ljava/util/concurrent/ConcurrentHashMap;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public sendActionIntent(Ljava/util/concurrent/ConcurrentHashMap;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public updateSelectionMenu()V
    ...
    iget v4, p0, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->mLimitedCount:I

    iget v5, p0, Lcom/samsung/contacts/interactions/InteractionGroupSelectionActivity;->mCurrentCount:I
