...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSelectedContactHashMap:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mTempHashMap:Ljava/util/HashMap;
...
.method private addContactFromSelectAll(JILandroid/net/Uri;)V
    ...
    iget-object v2, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSelectedContactHashMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private addSelectedDataInfo(Lcom/samsung/contacts/interactions/InteractionContactDatas$DataInfo;Ljava/lang/String;Landroid/net/Uri;J)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSelectedContactHashMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private doSelectAllAction(Z)Z
    ...
    iget-object v8, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSelectedContactHashMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSelectedContactHashMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mContactIdArrayForQuerySelection:Ljava/util/List;
    ...
    :cond_0
    iget-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mContactUriForDirectoryEntityQuery:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mProfileIdForSelectAll:Ljava/lang/String;
    :try_end_0
    ...
    invoke-direct {p0, v0, v10, v2}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->removeContactFromSelectAll(Ljava/lang/String;ILjava/lang/String;)V
    ...
    iget v11, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mCurrentCount:I
    ...
    invoke-virtual {p0, v0, v10, v2}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->isSelectedContact(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    iget-object v2, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mContactIdArrayForQuerySelection:Ljava/util/List;

    iget-object v3, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mContactUriForDirectoryEntityQuery:Ljava/util/List;

    iget-object v4, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mProfileIdForSelectAll:Ljava/lang/String;

    iget v5, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mActionCode:I

    iget v6, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mLimitedCount:I

    iget v7, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mCurrentCount:I
    ...
    iput-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mContactUriForDirectoryEntityQuery:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mContactIdArrayForQuerySelection:Ljava/util/List;
...
.method private setSelectAllCheckedVcard(Z)Z
    ...
    iget-object v10, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSelectedContactHashMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v8, Lcom/samsung/contacts/interactions/InteractionContactListAdapter;

    invoke-virtual {v8, v5}, Lcom/samsung/contacts/interactions/InteractionContactListAdapter;->getContactUri(I)Landroid/net/Uri;
    ...
    invoke-virtual {p0, v8, v4, v11}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->isSelectedContact(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    :cond_4
    :try_start_3
    invoke-direct {p0, v2, v3, v4, v7}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->addContactFromSelectAll(JILandroid/net/Uri;)V
    :try_end_3
    ...
    :cond_5
    :try_start_5
    invoke-direct {p0, v2, v3, v4}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->removeVcardFromSelectAll(JI)V
    :try_end_5
...
.method public clearSelectedArray()V
    ...
    invoke-virtual {v0, v1}, Lcom/samsung/contacts/interactions/InteractionContactListAdapter;->setSelctedContactHashMap(Ljava/util/concurrent/ConcurrentHashMap;)V
...
.method public excuteSelectAllContacts()Z
    ...
    iget-boolean v3, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mIsRecreatedInstance:Z

    if-eqz v3, :cond_2

    iget-boolean v3, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mIsSelectAllTaskRunning:Z
    ...
    :goto_0
    iget-object v3, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->selectAllTaskContacts:Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment$SelectAllTaskContacts;

    if-eqz v3, :cond_0

    iget-object v3, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->selectAllTaskContacts:Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment$SelectAllTaskContacts;

    invoke-virtual {v3, v2}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment$SelectAllTaskContacts;->cancel(Z)Z

    :cond_0
    new-instance v3, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment$SelectAllTaskContacts;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment$SelectAllTaskContacts;-><init>(Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment$1;)V
    ...
    iget-boolean v5, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mIsSelectAllChecked:Z
    ...
    invoke-virtual {v3, v4}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment$SelectAllTaskContacts;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    iget-object v3, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSelectAllCheck:Lcom/sec/android/touchwiz/widget/TwCheckBox;
...
.method public excuteSelectAllVcard()Z
    ...
    invoke-virtual {v3, v4}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment$SelectAllTaskVcard;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method protected onHeaderViewClick(Landroid/view/View;IJ)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->excuteSelectAllVcard()Z
    ...
    :cond_2
    invoke-virtual {p0}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->excuteSelectAllContacts()Z
...
.method protected onItemClick(IJ)V
    ...
    invoke-virtual {v5}, Lcom/android/contacts/common/list/ContactEntryListAdapter;->notifyDataSetChanged()V
...
.method public onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    iget-object v4, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSelectedContactHashMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget v4, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mDirectoryListStatus:I

    if-nez v4, :cond_d

    const/4 v4, 0x1

    iput v4, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mDirectoryListStatus:I
    ...
    invoke-direct {p0, v3}, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->configureEmptyView(Z)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mTempHashMap:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mTempHashMap:Ljava/util/HashMap;
...
.method protected showCount(ILandroid/database/Cursor;)V
    ...
    :cond_8
    iget-object v2, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSearchHeaderView:Landroid/view/View;

    invoke-virtual {v2, v5}, Landroid/view/View;->setVisibility(I)V

    iget-object v2, p0, Lcom/samsung/contacts/interactions/InteractionPickerContactsFragment;->mSearchNoMatchesView:Landroid/view/View;
