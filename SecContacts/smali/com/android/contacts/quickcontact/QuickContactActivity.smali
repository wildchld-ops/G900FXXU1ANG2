...
.field private mDisplayNameContainer:Landroid/widget/LinearLayout;
...
.method private bindData(Lcom/android/contacts/model/Contact;)V
    ...
    invoke-virtual {v2}, Lcom/android/contacts/model/Contact;->getRawContacts()Lcom/google/common/collect/ImmutableList;
    ...
    iget-object v3, v0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mDisplayNameContainer:Landroid/widget/LinearLayout;

    if-eqz v3, :cond_12

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mCompanyName:Lcom/samsung/contacts/widget/StrokeTextView;
    ...
    invoke-virtual {v3, v4}, Lcom/samsung/contacts/widget/ContactPhotoView;->setTextAlphaBackgroundTop(I)V
    ...
    invoke-static {v2, v4, v5}, Lcom/android/contacts/detail/ContactDetailDisplayUtils;->setDataOrHideIfNoneCompanyName(Ljava/lang/CharSequence;Landroid/widget/TextView;Landroid/view/View;)Z

    move-result v2

    invoke-virtual {v3, v2}, Lcom/samsung/contacts/widget/ContactPhotoView;->hasCompanyName(Z)V
...
.method private inflateAction(Ljava/lang/String;Lcom/android/contacts/quickcontact/ResolveCache;Landroid/view/ViewGroup;Ljava/lang/String;)Landroid/view/View;
    ...
    invoke-virtual {v2, v3}, Lcom/samsung/contacts/sim/PhoneBookManageSim;->getSimContactDetailIcon(I)I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    const-string v7, "is_invalid_uri"

    invoke-virtual {v1, v7, v9}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mShowOrCreateMode:Z

    new-instance v7, Landroid/os/Bundle;

    invoke-direct {v7}, Landroid/os/Bundle;-><init>()V

    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mCreateExtras:Landroid/os/Bundle;

    invoke-static {p0}, Lcom/android/contacts/ContactsUtils;->isEasyMode(Landroid/content/Context;)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mIsEasyMode:Z

    invoke-static {p0}, Lcom/android/contacts/util/PhoneCapabilityTester;->isPhone(Landroid/content/Context;)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mHasPhone:Z

    invoke-static {p0}, Lcom/android/contacts/util/PhoneCapabilityTester;->isSmsIntentRegistered(Landroid/content/Context;)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mHasSms:Z
    ...
    invoke-virtual {v7}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getEnableIpCall()Z
    ...
    :goto_0
    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mHasIpCall:Z
    ...
    invoke-virtual {v7}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getEnableMultiSimContacts()Z
    ...
    invoke-virtual {v7, v9}, Lcom/samsung/contacts/sim/PhoneBookManageSim;->isSimEnabled(I)Z
    ...
    invoke-virtual {v7, v8}, Lcom/samsung/contacts/sim/PhoneBookManageSim;->isSimEnabled(I)Z
    ...
    :goto_1
    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mHasMultiSimCall:Z

    iget-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mHasPhone:Z

    invoke-static {v7}, Lcom/android/contacts/quickcontact/DataAction;->setPhoneAvailable(Z)V

    iget-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mHasSms:Z

    invoke-static {v7}, Lcom/android/contacts/quickcontact/DataAction;->setSmsAvailable(Z)V

    iget-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mIsEasyMode:Z

    invoke-static {v7}, Lcom/android/contacts/quickcontact/DataAction;->setIsEasyMode(Z)V

    iget-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mShowOrCreateMode:Z
    ...
    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mCreateExtras:Landroid/os/Bundle;
    ...
    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mIsProfile:Z
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mScheme:Ljava/lang/String;
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mSsp:Ljava/lang/String;

    const-string v7, "mailto"

    iget-object v10, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mScheme:Ljava/lang/String;
    ...
    iput v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mCurrentMode:I

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mCreateExtras:Landroid/os/Bundle;

    const-string v10, "email"

    iget-object v11, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mSsp:Ljava/lang/String;
    ...
    iput-boolean v8, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mIsEmailCreateMode:Z

    invoke-direct {p0}, Lcom/android/contacts/quickcontact/QuickContactActivity;->isEASAccountRegistered()Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mHasEASAccount:Z

    :cond_1
    :goto_2
    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mScheme:Ljava/lang/String;
    ...
    :cond_2
    iput-boolean v9, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mShowOrCreateMode:Z

    :cond_3
    :goto_3
    const-string v7, "exclude_mimes"

    invoke-virtual {v1, v7}, Landroid/content/Intent;->getStringArrayExtra(Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v7

    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mExcludeMimes:[Ljava/lang/String;

    iget-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mIsEmailCreateMode:Z

    if-ne v7, v8, :cond_e

    iget-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mHasEASAccount:Z

    if-ne v7, v8, :cond_e

    if-eqz p1, :cond_d

    const-string v7, "is_eas_mode"

    invoke-virtual {p1, v7}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;)Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mIsEASMode:Z

    const-string v7, "lookup_uri"
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mRcsViews:Ljava/util/LinkedList;

    new-instance v7, Lcom/samsung/contacts/model/rcs/FeatureTagGrupper;

    invoke-direct {v7}, Lcom/samsung/contacts/model/rcs/FeatureTagGrupper;-><init>()V

    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mFeatureGrupper:Lcom/samsung/contacts/model/rcs/FeatureTagGrupper;

    invoke-static {}, Lcom/google/common/collect/Lists;->newArrayList()Ljava/util/ArrayList;

    move-result-object v7

    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mRcsActionMimeTypes:Ljava/util/List;

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mLookupUri:Landroid/net/Uri;
    ...
    const-string v7, "tutorial_mode_from_dialer"
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mphotoView:Lcom/samsung/contacts/widget/ContactPhotoView;
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mPhotoInterceptView:Landroid/view/View;
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mphotoContainer:Landroid/widget/RelativeLayout;
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mStarImage:Landroid/widget/ImageView;
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mDisplayNameContainer:Landroid/widget/LinearLayout;
    ...
    check-cast v7, Lcom/samsung/contacts/widget/StrokeTextView;

    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mName:Lcom/samsung/contacts/widget/StrokeTextView;
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mCompanyName:Lcom/samsung/contacts/widget/StrokeTextView;
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mEmptyView:Landroid/view/View;
    ...
    new-instance v9, Lcom/android/contacts/quickcontact/QuickContactActivity$2;

    invoke-direct {v9, p0}, Lcom/android/contacts/quickcontact/QuickContactActivity$2;-><init>(Lcom/android/contacts/quickcontact/QuickContactActivity;)V

    invoke-virtual {v7, v9}, Lcom/android/contacts/quickcontact/FloatingChildLayout;->setOnOutsideTouchListener(Landroid/view/View$OnTouchListener;)V

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mFloatingLayout:Lcom/android/contacts/quickcontact/FloatingChildLayout;

    iget-object v9, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mCreateExtras:Landroid/os/Bundle;

    invoke-virtual {v7, v9}, Lcom/android/contacts/quickcontact/FloatingChildLayout;->setCreateExtras(Landroid/os/Bundle;)V

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mFloatingLayout:Lcom/android/contacts/quickcontact/FloatingChildLayout;

    iget-boolean v9, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mIsProfile:Z

    invoke-static {v9}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v9

    invoke-virtual {v7, v9}, Lcom/android/contacts/quickcontact/FloatingChildLayout;->setIsProfile(Ljava/lang/Boolean;)V
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mOpenDetailsClickHandler:Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v7, p0, v9}, Lcom/android/contacts/quickcontact/QuickContactActivity$ViewPagerAdapter;-><init>(Lcom/android/contacts/quickcontact/QuickContactActivity;Landroid/app/FragmentManager;)V

    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mPagerAdapter:Lcom/android/contacts/quickcontact/QuickContactActivity$ViewPagerAdapter;

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mListPager:Landroid/support/v4/view/ViewPager;

    iget-object v9, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mPagerAdapter:Lcom/android/contacts/quickcontact/QuickContactActivity$ViewPagerAdapter;

    invoke-virtual {v7, v9}, Landroid/support/v4/view/ViewPager;->setAdapter(Landroid/support/v4/view/PagerAdapter;)V

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mListPager:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v7, v8}, Landroid/support/v4/view/ViewPager;->disableBounceBack(Z)V
    ...
    invoke-direct {v8, p0, v9}, Lcom/android/contacts/quickcontact/QuickContactActivity$PageChangeListener;-><init>(Lcom/android/contacts/quickcontact/QuickContactActivity;Lcom/android/contacts/quickcontact/QuickContactActivity$1;)V
    ...
    invoke-virtual {v7, v6}, Lcom/android/contacts/quickcontact/FloatingChildLayout;->setChildTargetScreen(Landroid/graphics/Rect;)V

    :cond_5
    new-instance v7, Lcom/android/contacts/quickcontact/QuickContactActivity$4;

    invoke-direct {v7, p0}, Lcom/android/contacts/quickcontact/QuickContactActivity$4;-><init>(Lcom/android/contacts/quickcontact/QuickContactActivity;)V

    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;

    new-instance v0, Landroid/content/IntentFilter;

    invoke-direct {v0}, Landroid/content/IntentFilter;-><init>()V

    const-string v7, "com.android.contacts.action.QUICK_CONTACT_DESTROY"

    invoke-virtual {v0, v7}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mBtnContainer:Landroid/view/View;

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mFloatingLayout:Lcom/android/contacts/quickcontact/FloatingChildLayout;

    new-instance v8, Lcom/android/contacts/quickcontact/QuickContactActivity$5;

    invoke-direct {v8, p0}, Lcom/android/contacts/quickcontact/QuickContactActivity$5;-><init>(Lcom/android/contacts/quickcontact/QuickContactActivity;)V

    invoke-static {v7, v8}, Lcom/android/contacts/util/SchedulingUtils;->doAfterLayout(Landroid/view/View;Ljava/lang/Runnable;)V

    new-instance v7, Lcom/samsung/dialer/impl/VoLTEStateTrackerImpl;

    invoke-direct {v7, p0}, Lcom/samsung/dialer/impl/VoLTEStateTrackerImpl;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mVoLTEStateTrackerImpl:Lcom/samsung/dialer/impl/VoLTEStateTrackerImpl;

    iget-object v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mVoLTEStateTrackerImpl:Lcom/samsung/dialer/impl/VoLTEStateTrackerImpl;

    invoke-virtual {v7}, Lcom/samsung/dialer/impl/VoLTEStateTrackerImpl;->isEnableVoLTE()Z

    move-result v7

    iput-boolean v7, p0, Lcom/android/contacts/quickcontact/QuickContactActivity;->mIsVoLTEEnabled:Z
    ...
    invoke-static {v7, v10}, Landroid/provider/ContactsContract$RawContacts;->getContactLookupUri(Landroid/content/ContentResolver;Landroid/net/Uri;)Landroid/net/Uri;
