...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;,
...
.field private mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;
...
.method private addIceEmergencyContactsHeader(Landroid/view/LayoutInflater;)V
    .locals 2
...
.method protected createCustomMultiSelectModeSearchView()V
    ...
    invoke-static {v0, v1}, Lcom/samsung/contacts/impl/NearPlaceProviderManager;->setSearchViewQueryHint(Landroid/content/Context;Landroid/widget/SearchView;)V
    ...
    new-instance v1, Lcom/android/contacts/list/DefaultContactBrowseListFragment$7;

    invoke-direct {v1, p0}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$7;-><init>(Lcom/android/contacts/list/DefaultContactBrowseListFragment;)V
...
.method protected onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V
    ...
    const-string v3, "SprintICE"

    invoke-static {}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getInstance()Lcom/samsung/contacts/util/LoadCscFeatureUtils;

    move-result-object v4

    invoke-virtual {v4}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getConfigAdditionalGroup()Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->addIceEmergencyContactsHeader(Landroid/view/LayoutInflater;)V
    ...
    const-wide v5, 0x3fe851eb851eb852L
...
.method protected onItemClick(IJ)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->onContactSelected(IJ)V
...
.method public onItemLongClick(Lcom/sec/android/touchwiz/widget/TwAdapterView;Landroid/view/View;IJ)Z
    ...
    iget-object v2, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;

    invoke-virtual {v2, v1, p4, p5}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->onContactSelected(IJ)V
...
.method public onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    invoke-virtual {v0}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->updateActionBarTitle()V

    iget-object v0, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;

    invoke-virtual {v0}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->updateSelectAllState()V

    iget-object v0, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;

    invoke-virtual {v0}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->invalidateOptionsMenu()V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->findAndSelectPosition(J)V
...
.method public registerBezelListener()V
    ...
    new-instance v0, Lcom/android/contacts/list/DefaultContactBrowseListFragment$6;

    invoke-direct {v0, p0}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$6;-><init>(Lcom/android/contacts/list/DefaultContactBrowseListFragment;)V
...
.method protected showCount(ILandroid/database/Cursor;)V
    ...
    :cond_2
    :goto_4
    iget-object v3, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;
    ...
    invoke-virtual {v3}, Lcom/android/contacts/common/list/ContactListAdapter;->areAllPartitionsEmpty()Z
    ...
    invoke-virtual {v3}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->hideSelectAllHeader()V
    ...
    iput v5, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mSoftInputMode:I
    ...
    invoke-virtual {v3}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->showSelectAllHeader()V
...
.method public startActionMode()V
    ...
    new-instance v0, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;-><init>(Lcom/android/contacts/list/DefaultContactBrowseListFragment;Landroid/app/Activity;Landroid/view/View;)V

    iput-object v0, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;

    iget-object v0, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;

    const v1, 0x7f110016

    invoke-virtual {v0, v1}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->setActionModeMenu(I)V

    iget-object v0, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;

    iget-object v1, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mSelectedUris:Ljava/util/HashMap;

    invoke-virtual {v0, v1}, Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;->setSelectedItemsMap(Ljava/util/Map;)V
    ...
    iget-object v1, p0, Lcom/android/contacts/list/DefaultContactBrowseListFragment;->mActionModeAdapter:Lcom/android/contacts/list/DefaultContactBrowseListFragment$ActionModeAdapter;
