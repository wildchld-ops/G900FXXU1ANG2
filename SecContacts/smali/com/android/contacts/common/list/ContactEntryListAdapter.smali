...
.method protected bindHeaderView(Landroid/view/View;ILandroid/database/Cursor;)V
    ...
    instance-of v13, v12, Lcom/android/contacts/common/list/DirectoryPartition;
    ...
    iget-object v13, v0, Lcom/android/contacts/common/list/ContactEntryListAdapter;->mDefaultFilterHeaderText:Ljava/lang/CharSequence;
    ...
    :goto_2
    invoke-virtual/range {p0 .. p0}, Lcom/android/contacts/common/list/ContactEntryListAdapter;->getContext()Landroid/content/Context;
    ...
    invoke-static {v13, v7, v0, v1}, Lcom/samsung/contacts/impl/NearPlaceProviderManager;->setOptionViewVisibility(Landroid/content/Context;Lcom/android/contacts/common/list/DirectoryPartition;ILandroid/view/View;)V

    goto :goto_0

    :cond_2
    const v13, 0x7f0e010d
    ...
    invoke-static {v0, v12, v2, v1}, Lcom/samsung/contacts/impl/NearPlaceProviderManager;->getCountExceptCustomItem(ILcom/android/common/widget/CompositeCursorAdapter$Partition;ILandroid/database/Cursor;)I
    ...
    invoke-static {v7, v8}, Lcom/samsung/contacts/impl/NearPlaceProviderManager;->getDirectoryResultLimit(Lcom/android/contacts/common/list/DirectoryPartition;I)I
    ...
    iget-object v13, v0, Lcom/android/contacts/common/list/ContactEntryListAdapter;->mContext:Landroid/content/Context;

    const v14, 0x7f0e0112
    ...
    invoke-virtual {v0, v2, v13, v14}, Lcom/android/contacts/common/list/ContactEntryListAdapter;->getQuantityText(III)Ljava/lang/String;
...
.method public changeDirectories(Landroid/database/Cursor;)V
    ...
    invoke-static {v10}, Lcom/samsung/contacts/impl/NearPlaceProviderManager;->isKt114Partition(Lcom/android/contacts/common/list/DirectoryPartition;)Z
    ...
    invoke-virtual {v0, v13, v10}, Lcom/android/contacts/common/list/ContactEntryListAdapter;->addPartition(ILcom/android/common/widget/CompositeCursorAdapter$Partition;)V
