...
.field private mButtonLayoutManager:Lcom/samsung/contacts/detail/ContactDetailButtonLayoutManager;
...
.field private mTypeList:[Ljava/lang/CharSequence;
...
.method private buildConnectionEntries(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    new-instance v1, Lcom/samsung/contacts/detail/TargetContactData;
    ...
    invoke-direct {v1, v2, v3}, Lcom/samsung/contacts/detail/TargetContactData;-><init>(Lcom/android/contacts/model/Contact;Landroid/content/Context;)V

    invoke-virtual {v1}, Lcom/samsung/contacts/detail/TargetContactData;->isPaceable()Z
...
.method private buildPhoneEntries(Lcom/android/contacts/model/dataitem/DataItem;Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;Lcom/android/contacts/common/model/dataitem/DataKind;)V
    ...
    iget-boolean v0, v0, Lcom/samsung/contacts/detail/ContactDetailButtonLayoutManager;->mUseHorizontalButton:Z

    if-nez v0, :cond_3

    iget-object v0, p2, Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;->data:Ljava/lang/String;

    invoke-static {v0}, Lcom/android/contacts/ContactsUtils;->getVideoCallIntent(Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    iput-object v0, p2, Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;->secondaryIntent:Landroid/content/Intent;
    ...
    invoke-virtual {v0}, Lcom/samsung/contacts/detail/ContactDetailIconManager;->getVideoCallIcon()I

    move-result v0

    iput v0, p2, Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;->secondaryActionIcon:I

    const v0, 0x7f0e0309

    iput v0, p2, Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;->secondaryActionDescription:I

    iget-object v0, p2, Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;->data:Ljava/lang/String;

    invoke-direct {p0, v0}, Lcom/android/contacts/detail/ContactDetailFragment;->getSmsIntent(Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    iput-object v0, p2, Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;->thirdIntent:Landroid/content/Intent;

    iget-object v0, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mIconManager:Lcom/samsung/contacts/detail/ContactDetailIconManager;

    invoke-virtual {v0}, Lcom/samsung/contacts/detail/ContactDetailIconManager;->getMessageIcon()I

    move-result v0

    iput v0, p2, Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;->thirdActionIcon:I

    const v0, 0x7f0e030b

    iput v0, p2, Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;->thirdActionDescription:I
...
.method private copyToClipboard(I)V
    ...
    invoke-static {v2, v0, v1, v3}, Lcom/android/contacts/common/ClipboardUtils;->copyText(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)V
...
.method private flattenListForPhone(Ljava/util/ArrayList;)V
    ...
    iput-object v0, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mTypeList:[Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mTypeList:[Ljava/lang/CharSequence;
...
.method private getSmsIntent(Ljava/lang/String;)Landroid/content/Intent;
    .locals 4
...
.method protected bindData()V
    ...
    :cond_4
    new-instance v0, Lcom/samsung/contacts/detail/ContactDetailButtonLayoutManager;

    iget-object v1, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/samsung/contacts/detail/ContactDetailButtonLayoutManager;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mButtonLayoutManager:Lcom/samsung/contacts/detail/ContactDetailButtonLayoutManager;
    ...
    invoke-virtual {v0, v1}, Lcom/android/contacts/detail/PhotoSelectionHandler;->setState(Lcom/android/contacts/model/RawContactDeltaList;)V
    ...
    invoke-static {v1, v7}, Lcom/android/contacts/detail/ContactDetailDisplayUtils;->getCompany(Landroid/content/Context;Lcom/android/contacts/model/Contact;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lcom/samsung/contacts/widget/ContactPhotoView;->setTextAlphaBackgroundTop(I)V

    :cond_6
    :goto_2
    invoke-static {v1, v2, v6}, Lcom/android/contacts/detail/ContactDetailDisplayUtils;->setDataOrHideIfNoneCompanyName(Ljava/lang/CharSequence;Landroid/widget/TextView;Landroid/view/View;)Z
    ...
    invoke-virtual {v1, v2, v3, v0}, Lcom/android/contacts/detail/ContactDetailPhotoSetter;->setupContactPhoto(Landroid/content/Context;Lcom/android/contacts/model/Contact;Lcom/samsung/contacts/widget/ContactPhotoView;)V
    ...
    invoke-virtual {v1}, Lcom/android/contacts/util/ImageViewDrawableSetter;->getPreviousBitmapHeight()I
    ...
    invoke-virtual {v2}, Lcom/android/contacts/util/ImageViewDrawableSetter;->getPreviousBitmapWidth()I
    ...
    :cond_11
    iput-boolean v5, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mIsSystemUIAppear:Z
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v2, v3}, Landroid/widget/AdapterView;->getItemIdAtPosition(I)J
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    :cond_0
    iget-boolean v3, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mIsGalContact:Z
    ...
    iget-boolean v3, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mPreload:Z
    ...
    invoke-interface {p1, v4, v1, v4, v3}, Landroid/view/ContextMenu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {p1, v4, v4, v4, v3}, Landroid/view/ContextMenu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-virtual {v3}, Lcom/samsung/contacts/util/LoadCscFeatureUtils;->getEnableCopyToDialer()Z
    ...
    invoke-interface {p1, v4, v3, v4, v6}, Landroid/view/ContextMenu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-virtual {v3, v6, p1, v0}, Lcom/samsung/contacts/sim/detail/DetailSimOperation;->addSimContextMenu(Landroid/content/Context;Landroid/view/ContextMenu;Lcom/android/contacts/detail/ContactDetailFragment$DetailViewEntry;)V
    ...
    :cond_9
    :goto_2
    iget-boolean v3, p0, Lcom/android/contacts/detail/ContactDetailFragment;->mIsUserProfile:Z
    ...
    const-string v1, "instant_letterring"
