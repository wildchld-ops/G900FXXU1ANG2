...
.field private mIsThereData:Z

.field private mIsThereNameData:Z
...
.method private isSendContactInfoVisible()Z
    ...
    iget-boolean v0, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsThereData:Z
...
.method private isThereDataItem()Z
    ...
    iput-boolean v12, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsThereNameData:Z
    ...
    instance-of v0, v1, Lcom/android/contacts/model/dataitem/StructuredNameDataItem;

    if-eqz v0, :cond_4

    iput-boolean v13, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsThereNameData:Z
...
.method private setContactInfos()V
    ...
    iput-boolean v0, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsThereData:Z
...
.method public isContactCanCreateShortcut()Z
    ...
    invoke-static {v1}, Lcom/android/contacts/ContactsUtils;->isKnoxContainerOnlyMode(Landroid/content/Context;)Z

    move-result v1

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsKnoxMode:Z
    ...
    :cond_1
    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsUserProfile:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsDirectoryEntry:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsEasymode:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsEmergencyMode:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsUltraPowerSavingMode:Z
...
.method public isContactDeletable()Z
    ...
    invoke-virtual {v0, v1, v2}, Lcom/samsung/contacts/sim/detail/DetailSimOperation;->isSimDeactivate(Landroid/content/Context;Lcom/android/contacts/model/Contact;)Z
...
.method public isContactShareable()Z
    ...
    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsWritable:Z
    ...
    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsThereData:Z

    if-nez v1, :cond_3

    iget-boolean v1, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mIsThereNameData:Z
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    new-instance v0, Lcom/samsung/contacts/detail/TargetContactData;

    iget-object v2, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mContactData:Lcom/android/contacts/model/Contact;

    iget-object v3, p0, Lcom/android/contacts/detail/ContactLoaderFragment;->mContext:Landroid/content/Context;

    invoke-direct {v0, v2, v3}, Lcom/samsung/contacts/detail/TargetContactData;-><init>(Lcom/android/contacts/model/Contact;Landroid/content/Context;)V
    ...
    const-string v5, "com.android.contacts.action.JOIN_CONTACT"
    ...
    invoke-virtual {v0}, Lcom/samsung/contacts/detail/TargetContactData;->isPaceable()Z

    move-result v2

    if-eqz v2, :cond_2

    const-string v2, "targetContactData"
    ...
    .sparse-switch
        ...
        0x7f08031e -> :sswitch_8
        0x7f080341 -> :sswitch_6
        0x7f08034c -> :sswitch_4
        0x7f08034d -> :sswitch_9
        0x7f08034e -> :sswitch_a
        0x7f08037b -> :sswitch_1
        0x7f08037c -> :sswitch_2
        0x7f08037d -> :sswitch_3
        0x7f08037e -> :sswitch_b
        0x7f08037f -> :sswitch_5
        0x7f080380 -> :sswitch_7
    .end sparse-switch
.end method
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    invoke-static {v12}, Lcom/android/contacts/ContactsUtils;->isEmergencyMode(Landroid/content/Context;)Z
